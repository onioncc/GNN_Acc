...
set C_modelArgList {
	...
	{ weight_buf int 32 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "weight_buf", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ weight_buf_din sc_out sc_lv 32 signal 1 } 
	{ weight_buf_full_n sc_in sc_logic 1 signal 1 } 
	{ weight_buf_write sc_out sc_logic 1 signal 1 } 
	{ weights sc_in sc_lv 64 signal 2 } 
	{ d_out sc_in sc_lv 5 signal 3 } 
	{ d_out_out_din sc_out sc_lv 5 signal 4 } 
	{ d_out_out_full_n sc_in sc_logic 1 signal 4 } 
	{ d_out_out_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "weight_buf_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "weight_buf", "role": "din" }} , 
 	{ "name": "weight_buf_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "weight_buf", "role": "full_n" }} , 
 	{ "name": "weight_buf_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "weight_buf", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "weight_buf", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	weight_buf { ap_fifo {  { weight_buf_din fifo_data 1 32 }  { weight_buf_full_n fifo_status 0 1 }  { weight_buf_write fifo_update 1 1 } } }
	weights { ap_none {  { weights in_data 0 64 } } }
	d_out { ap_none {  { d_out in_data 0 5 } } }
