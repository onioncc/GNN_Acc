...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { edge_embedding_table_V_address1 { O 15 vector } edge_embedding_table_V_ce1 { O 1 bit } edge_embedding_table_V_we1 { O 1 bit } edge_embedding_table_V_d1 { O 32 vector } } \
} "
} else {
