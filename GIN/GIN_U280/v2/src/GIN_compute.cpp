...
void message_passing_one_node2(int nd, FM_TYPE* node_emb_vec, int mt_id, int edge_attr[MAX_EDGE][EDGE_ATTR], int layer)
{
#pragma HLS inline off
...
#pragma HLS pipeline
            ...
            FM_TYPE msg = edge_embed + node_emb_vec[dim];
            if(msg < 0) msg = 0.0;
