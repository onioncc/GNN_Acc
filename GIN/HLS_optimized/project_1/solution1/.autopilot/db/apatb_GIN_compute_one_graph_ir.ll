; ModuleID = '/nethome/chao33/GNN_Acc/GIN/HLS_optimized/project_1/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %gnn_node_mlp_1_weights_fixed_copy = bitcast i8* %malloccall5 to [100000 x %struct.ap_fixed]*
  %gnn_node_mlp_1_bias_fixed_copy = alloca [1000 x %struct.ap_fixed], align 512
  %malloccall6 = tail call i8* @malloc(i64 400000)
  %gnn_node_mlp_2_weights_fixed_copy = bitcast i8* %malloccall6 to [100000 x %struct.ap_fixed]*
  %gnn_node_mlp_2_bias_fixed_copy = alloca [500 x %struct.ap_fixed], align 512
  %malloccall7 = tail call i8* @malloc(i64 69200)
  %gnn_node_embedding_fixed_copy = bitcast i8* %malloccall7 to [17300 x %struct.ap_fixed]*
  %malloccall8 = tail call i8* @malloc(i64 26000)
  %gnn_edge_embedding_fixed_copy = bitcast i8* %malloccall8 to [6500 x %struct.ap_fixed]*
  %graph_pred_linear_weight_fixed_copy = alloca [100 x %struct.ap_fixed], align 512
  ...
  %5 = bitcast %struct.ap_fixed* %gnn_node_mlp_1_weights_fixed to [100000 x %struct.ap_fixed]*
  %6 = bitcast %struct.ap_fixed* %gnn_node_mlp_1_bias_fixed to [1000 x %struct.ap_fixed]*
  %7 = bitcast %struct.ap_fixed* %gnn_node_mlp_2_weights_fixed to [100000 x %struct.ap_fixed]*
  %8 = bitcast %struct.ap_fixed* %gnn_node_mlp_2_bias_fixed to [500 x %struct.ap_fixed]*
  %9 = bitcast %struct.ap_fixed* %gnn_node_embedding_fixed to [17300 x %struct.ap_fixed]*
  %10 = bitcast %struct.ap_fixed* %gnn_edge_embedding_fixed to [6500 x %struct.ap_fixed]*
  %11 = bitcast %struct.ap_fixed* %graph_pred_linear_weight_fixed to [100 x %struct.ap_fixed]*
  ...
  call fastcc void @copy_in([100000 x i32]* %0, [100000 x i32]* %node_feature_in_copy, [100000 x i32]* %1, [100000 x i32]* %edge_list_in_copy, [100000 x i32]* %2, [100000 x i32]* %edge_attr_in_copy, [100000 x i32]* %3, [100000 x i32]* %graph_attr_copy, [100000 x %struct.ap_fixed]* %4, [100000 x %struct.ap_fixed]* %task_copy, [100000 x %struct.ap_fixed]* %5, [100000 x %struct.ap_fixed]* %gnn_node_mlp_1_weights_fixed_copy, [1000 x %struct.ap_fixed]* %6, [1000 x %struct.ap_fixed]* nonnull align 512 %gnn_node_mlp_1_bias_fixed_copy, [100000 x %struct.ap_fixed]* %7, [100000 x %struct.ap_fixed]* %gnn_node_mlp_2_weights_fixed_copy, [500 x %struct.ap_fixed]* %8, [500 x %struct.ap_fixed]* nonnull align 512 %gnn_node_mlp_2_bias_fixed_copy, [17300 x %struct.ap_fixed]* %9, [17300 x %struct.ap_fixed]* %gnn_node_embedding_fixed_copy, [6500 x %struct.ap_fixed]* %10, [6500 x %struct.ap_fixed]* %gnn_edge_embedding_fixed_copy, [100 x %struct.ap_fixed]* %11, [100 x %struct.ap_fixed]* nonnull align 512 %graph_pred_linear_weight_fixed_copy, [1 x %struct.ap_fixed]* %12, [1 x %struct.ap_fixed]* nonnull align 512 %graph_pred_linear_bias_fixed_copy, [5 x %struct.ap_fixed]* %13, [5 x %struct.ap_fixed]* nonnull align 512 %eps_fixed_copy)
  ...
  %19 = getelementptr inbounds [100000 x %struct.ap_fixed], [100000 x %struct.ap_fixed]* %gnn_node_mlp_1_weights_fixed_copy, i32 0, i32 0
  %20 = getelementptr inbounds [1000 x %struct.ap_fixed], [1000 x %struct.ap_fixed]* %gnn_node_mlp_1_bias_fixed_copy, i32 0, i32 0
  %21 = getelementptr inbounds [100000 x %struct.ap_fixed], [100000 x %struct.ap_fixed]* %gnn_node_mlp_2_weights_fixed_copy, i32 0, i32 0
  %22 = getelementptr inbounds [500 x %struct.ap_fixed], [500 x %struct.ap_fixed]* %gnn_node_mlp_2_bias_fixed_copy, i32 0, i32 0
  %23 = getelementptr inbounds [17300 x %struct.ap_fixed], [17300 x %struct.ap_fixed]* %gnn_node_embedding_fixed_copy, i32 0, i32 0
  %24 = getelementptr inbounds [6500 x %struct.ap_fixed], [6500 x %struct.ap_fixed]* %gnn_edge_embedding_fixed_copy, i32 0, i32 0
  %25 = getelementptr inbounds [100 x %struct.ap_fixed], [100 x %struct.ap_fixed]* %graph_pred_linear_weight_fixed_copy, i32 0, i32 0
...
; Function Attrs: noinline
define internal fastcc void @copy_in([100000 x i32]* readonly, [100000 x i32]* noalias, [100000 x i32]* readonly, [100000 x i32]* noalias, [100000 x i32]* readonly, [100000 x i32]* noalias, [100000 x i32]* readonly, [100000 x i32]* noalias, [100000 x %struct.ap_fixed]*, [100000 x %struct.ap_fixed]* noalias, [100000 x %struct.ap_fixed]*, [100000 x %struct.ap_fixed]* noalias, [1000 x %struct.ap_fixed]*, [1000 x %struct.ap_fixed]* noalias align 512, [100000 x %struct.ap_fixed]*, [100000 x %struct.ap_fixed]* noalias, [500 x %struct.ap_fixed]*, [500 x %struct.ap_fixed]* noalias align 512, [17300 x %struct.ap_fixed]*, [17300 x %struct.ap_fixed]* noalias, [6500 x %struct.ap_fixed]*, [6500 x %struct.ap_fixed]* noalias, [100 x %struct.ap_fixed]*, [100 x %struct.ap_fixed]* noalias align 512, [1 x %struct.ap_fixed]*, [1 x %struct.ap_fixed]* noalias align 512, [5 x %struct.ap_fixed]*, [5 x %struct.ap_fixed]* noalias align 512) unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a100000struct.ap_fixed([100000 x %struct.ap_fixed]* %11, [100000 x %struct.ap_fixed]* %10)
  call fastcc void @onebyonecpy_hls.p0a1000struct.ap_fixed([1000 x %struct.ap_fixed]* align 512 %13, [1000 x %struct.ap_fixed]* %12)
  call fastcc void @onebyonecpy_hls.p0a100000struct.ap_fixed([100000 x %struct.ap_fixed]* %15, [100000 x %struct.ap_fixed]* %14)
  call fastcc void @onebyonecpy_hls.p0a500struct.ap_fixed([500 x %struct.ap_fixed]* align 512 %17, [500 x %struct.ap_fixed]* %16)
  call fastcc void @onebyonecpy_hls.p0a17300struct.ap_fixed([17300 x %struct.ap_fixed]* %19, [17300 x %struct.ap_fixed]* %18)
  call fastcc void @onebyonecpy_hls.p0a6500struct.ap_fixed([6500 x %struct.ap_fixed]* %21, [6500 x %struct.ap_fixed]* %20)
  call fastcc void @onebyonecpy_hls.p0a100struct.ap_fixed([100 x %struct.ap_fixed]* align 512 %23, [100 x %struct.ap_fixed]* %22)
...
; <label>:16:                                     ; preds = %12
  ...
  %17 = bitcast i28* %dst.addr.0.0.06.gep7 to i8*
  ...
  %18 = bitcast i28* %src.addr.0.0.05.gep8 to i8*
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0a1000struct.ap_fixed([1000 x %struct.ap_fixed]* noalias align 512, [1000 x %struct.ap_fixed]* noalias) unnamed_addr #4 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0a500struct.ap_fixed([500 x %struct.ap_fixed]* noalias align 512, [500 x %struct.ap_fixed]* noalias) unnamed_addr #4 {
entry:
  %2 = icmp eq [500 x %struct.ap_fixed]* %0, null
  %3 = icmp eq [500 x %struct.ap_fixed]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop.head, %copy
  %for.loop.idx9 = phi i64 [ 0, %copy ], [ %for.loop.idx.next, %for.loop.head ]
  %dst.addr = getelementptr [500 x %struct.ap_fixed], [500 x %struct.ap_fixed]* %0, i64 0, i64 %for.loop.idx9
  %src.addr = getelementptr [500 x %struct.ap_fixed], [500 x %struct.ap_fixed]* %1, i64 0, i64 %for.loop.idx9
  %5 = bitcast %struct.ap_fixed* %src.addr to i8*
  %6 = call i1 @fpga_fifo_exist_4(i8* %5)
  br i1 %6, label %7, label %8
...
; <label>:8:                                      ; preds = %for.loop
  %src.addr.01 = getelementptr [500 x %struct.ap_fixed], [500 x %struct.ap_fixed]* %1, i64 0, i64 %for.loop.idx9, i32 0
  %dst.addr.02 = getelementptr [500 x %struct.ap_fixed], [500 x %struct.ap_fixed]* %0, i64 0, i64 %for.loop.idx9, i32 0
  %9 = bitcast %struct.ap_fixed_base* %src.addr.01 to i8*
  %10 = call i1 @fpga_fifo_exist_4(i8* %9)
  br i1 %10, label %11, label %12
...
; <label>:12:                                     ; preds = %8
  %src.addr.0.03 = getelementptr [500 x %struct.ap_fixed], [500 x %struct.ap_fixed]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %dst.addr.0.04 = getelementptr [500 x %struct.ap_fixed], [500 x %struct.ap_fixed]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %13 = bitcast %struct.ssdm_int* %src.addr.0.03 to i8*
  %14 = call i1 @fpga_fifo_exist_4(i8* %13)
  br i1 %14, label %15, label %16
...
; <label>:16:                                     ; preds = %12
  %dst.addr.0.0.06.gep7 = getelementptr [500 x %struct.ap_fixed], [500 x %struct.ap_fixed]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
  %17 = bitcast i28* %dst.addr.0.0.06.gep7 to i8*
  %src.addr.0.0.05.gep8 = getelementptr [500 x %struct.ap_fixed], [500 x %struct.ap_fixed]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
  %18 = bitcast i28* %src.addr.0.0.05.gep8 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %17, i8* align 1 %18, i64 4, i1 false)
  br label %for.loop.head
...
for.loop.head:                                    ; preds = %16, %15, %11, %7
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx9, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, 500
  br i1 %exitcond, label %for.loop, label %ret
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0a17300struct.ap_fixed([17300 x %struct.ap_fixed]* noalias, [17300 x %struct.ap_fixed]* noalias) unnamed_addr #4 {
entry:
  %2 = icmp eq [17300 x %struct.ap_fixed]* %0, null
  %3 = icmp eq [17300 x %struct.ap_fixed]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop.head, %copy
  %for.loop.idx9 = phi i64 [ 0, %copy ], [ %for.loop.idx.next, %for.loop.head ]
  %dst.addr = getelementptr [17300 x %struct.ap_fixed], [17300 x %struct.ap_fixed]* %0, i64 0, i64 %for.loop.idx9
  %src.addr = getelementptr [17300 x %struct.ap_fixed], [17300 x %struct.ap_fixed]* %1, i64 0, i64 %for.loop.idx9
  %5 = bitcast %struct.ap_fixed* %src.addr to i8*
  %6 = call i1 @fpga_fifo_exist_4(i8* %5)
  br i1 %6, label %7, label %8
...
; <label>:8:                                      ; preds = %for.loop
  %src.addr.01 = getelementptr [17300 x %struct.ap_fixed], [17300 x %struct.ap_fixed]* %1, i64 0, i64 %for.loop.idx9, i32 0
  %dst.addr.02 = getelementptr [17300 x %struct.ap_fixed], [17300 x %struct.ap_fixed]* %0, i64 0, i64 %for.loop.idx9, i32 0
  %9 = bitcast %struct.ap_fixed_base* %src.addr.01 to i8*
  %10 = call i1 @fpga_fifo_exist_4(i8* %9)
  br i1 %10, label %11, label %12
...
; <label>:12:                                     ; preds = %8
  %src.addr.0.03 = getelementptr [17300 x %struct.ap_fixed], [17300 x %struct.ap_fixed]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %dst.addr.0.04 = getelementptr [17300 x %struct.ap_fixed], [17300 x %struct.ap_fixed]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %13 = bitcast %struct.ssdm_int* %src.addr.0.03 to i8*
  %14 = call i1 @fpga_fifo_exist_4(i8* %13)
  br i1 %14, label %15, label %16
...
; <label>:16:                                     ; preds = %12
  %dst.addr.0.0.06.gep7 = getelementptr [17300 x %struct.ap_fixed], [17300 x %struct.ap_fixed]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
  %17 = bitcast i28* %dst.addr.0.0.06.gep7 to i8*
  %src.addr.0.0.05.gep8 = getelementptr [17300 x %struct.ap_fixed], [17300 x %struct.ap_fixed]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
  %18 = bitcast i28* %src.addr.0.0.05.gep8 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %17, i8* align 1 %18, i64 4, i1 false)
  br label %for.loop.head
...
for.loop.head:                                    ; preds = %16, %15, %11, %7
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx9, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, 17300
  br i1 %exitcond, label %for.loop, label %ret
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0a6500struct.ap_fixed([6500 x %struct.ap_fixed]* noalias, [6500 x %struct.ap_fixed]* noalias) unnamed_addr #4 {
entry:
  %2 = icmp eq [6500 x %struct.ap_fixed]* %0, null
  %3 = icmp eq [6500 x %struct.ap_fixed]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop.head, %copy
  %for.loop.idx9 = phi i64 [ 0, %copy ], [ %for.loop.idx.next, %for.loop.head ]
  %dst.addr = getelementptr [6500 x %struct.ap_fixed], [6500 x %struct.ap_fixed]* %0, i64 0, i64 %for.loop.idx9
  %src.addr = getelementptr [6500 x %struct.ap_fixed], [6500 x %struct.ap_fixed]* %1, i64 0, i64 %for.loop.idx9
  %5 = bitcast %struct.ap_fixed* %src.addr to i8*
  %6 = call i1 @fpga_fifo_exist_4(i8* %5)
  br i1 %6, label %7, label %8
...
; <label>:8:                                      ; preds = %for.loop
  %src.addr.01 = getelementptr [6500 x %struct.ap_fixed], [6500 x %struct.ap_fixed]* %1, i64 0, i64 %for.loop.idx9, i32 0
  %dst.addr.02 = getelementptr [6500 x %struct.ap_fixed], [6500 x %struct.ap_fixed]* %0, i64 0, i64 %for.loop.idx9, i32 0
  %9 = bitcast %struct.ap_fixed_base* %src.addr.01 to i8*
  %10 = call i1 @fpga_fifo_exist_4(i8* %9)
  br i1 %10, label %11, label %12
...
; <label>:12:                                     ; preds = %8
  %src.addr.0.03 = getelementptr [6500 x %struct.ap_fixed], [6500 x %struct.ap_fixed]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %dst.addr.0.04 = getelementptr [6500 x %struct.ap_fixed], [6500 x %struct.ap_fixed]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %13 = bitcast %struct.ssdm_int* %src.addr.0.03 to i8*
  %14 = call i1 @fpga_fifo_exist_4(i8* %13)
  br i1 %14, label %15, label %16
...
; <label>:16:                                     ; preds = %12
  %dst.addr.0.0.06.gep7 = getelementptr [6500 x %struct.ap_fixed], [6500 x %struct.ap_fixed]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
  %17 = bitcast i28* %dst.addr.0.0.06.gep7 to i8*
  %src.addr.0.0.05.gep8 = getelementptr [6500 x %struct.ap_fixed], [6500 x %struct.ap_fixed]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
  %18 = bitcast i28* %src.addr.0.0.05.gep8 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %17, i8* align 1 %18, i64 4, i1 false)
  br label %for.loop.head
...
for.loop.head:                                    ; preds = %16, %15, %11, %7
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx9, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, 6500
  br i1 %exitcond, label %for.loop, label %ret
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0a100struct.ap_fixed([100 x %struct.ap_fixed]* noalias align 512, [100 x %struct.ap_fixed]* noalias) unnamed_addr #4 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([100000 x i32]*, [100000 x i32]* noalias readonly, [100000 x i32]*, [100000 x i32]* noalias readonly, [100000 x i32]*, [100000 x i32]* noalias readonly, [100000 x i32]*, [100000 x i32]* noalias readonly, [100000 x %struct.ap_fixed]*, [100000 x %struct.ap_fixed]* noalias, [100000 x %struct.ap_fixed]*, [100000 x %struct.ap_fixed]* noalias, [1000 x %struct.ap_fixed]*, [1000 x %struct.ap_fixed]* noalias align 512, [100000 x %struct.ap_fixed]*, [100000 x %struct.ap_fixed]* noalias, [500 x %struct.ap_fixed]*, [500 x %struct.ap_fixed]* noalias align 512, [17300 x %struct.ap_fixed]*, [17300 x %struct.ap_fixed]* noalias, [6500 x %struct.ap_fixed]*, [6500 x %struct.ap_fixed]* noalias, [100 x %struct.ap_fixed]*, [100 x %struct.ap_fixed]* noalias align 512, [1 x %struct.ap_fixed]*, [1 x %struct.ap_fixed]* noalias align 512, [5 x %struct.ap_fixed]*, [5 x %struct.ap_fixed]* noalias align 512) unnamed_addr #6 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a100000struct.ap_fixed([100000 x %struct.ap_fixed]* %10, [100000 x %struct.ap_fixed]* %11)
  call fastcc void @onebyonecpy_hls.p0a1000struct.ap_fixed([1000 x %struct.ap_fixed]* %12, [1000 x %struct.ap_fixed]* align 512 %13)
  call fastcc void @onebyonecpy_hls.p0a100000struct.ap_fixed([100000 x %struct.ap_fixed]* %14, [100000 x %struct.ap_fixed]* %15)
  call fastcc void @onebyonecpy_hls.p0a500struct.ap_fixed([500 x %struct.ap_fixed]* %16, [500 x %struct.ap_fixed]* align 512 %17)
  call fastcc void @onebyonecpy_hls.p0a17300struct.ap_fixed([17300 x %struct.ap_fixed]* %18, [17300 x %struct.ap_fixed]* %19)
  call fastcc void @onebyonecpy_hls.p0a6500struct.ap_fixed([6500 x %struct.ap_fixed]* %20, [6500 x %struct.ap_fixed]* %21)
  call fastcc void @onebyonecpy_hls.p0a100struct.ap_fixed([100 x %struct.ap_fixed]* %22, [100 x %struct.ap_fixed]* align 512 %23)
...
entry:
  ...
  %19 = bitcast %struct.ap_fixed* %5 to [100000 x %struct.ap_fixed]*
  %20 = bitcast %struct.ap_fixed* %6 to [1000 x %struct.ap_fixed]*
  %21 = bitcast %struct.ap_fixed* %7 to [100000 x %struct.ap_fixed]*
  %22 = bitcast %struct.ap_fixed* %8 to [500 x %struct.ap_fixed]*
  %23 = bitcast %struct.ap_fixed* %9 to [17300 x %struct.ap_fixed]*
  %24 = bitcast %struct.ap_fixed* %10 to [6500 x %struct.ap_fixed]*
  %25 = bitcast %struct.ap_fixed* %11 to [100 x %struct.ap_fixed]*
  %26 = bitcast %struct.ap_fixed* %12 to [1 x %struct.ap_fixed]*
  %27 = bitcast %struct.ap_fixed* %13 to [5 x %struct.ap_fixed]*
  call void @copy_out([100000 x i32]* null, [100000 x i32]* %14, [100000 x i32]* null, [100000 x i32]* %15, [100000 x i32]* null, [100000 x i32]* %16, [100000 x i32]* null, [100000 x i32]* %17, [100000 x %struct.ap_fixed]* null, [100000 x %struct.ap_fixed]* %18, [100000 x %struct.ap_fixed]* null, [100000 x %struct.ap_fixed]* %19, [1000 x %struct.ap_fixed]* null, [1000 x %struct.ap_fixed]* %20, [100000 x %struct.ap_fixed]* null, [100000 x %struct.ap_fixed]* %21, [500 x %struct.ap_fixed]* null, [500 x %struct.ap_fixed]* %22, [17300 x %struct.ap_fixed]* null, [17300 x %struct.ap_fixed]* %23, [6500 x %struct.ap_fixed]* null, [6500 x %struct.ap_fixed]* %24, [100 x %struct.ap_fixed]* null, [100 x %struct.ap_fixed]* %25, [1 x %struct.ap_fixed]* null, [1 x %struct.ap_fixed]* %26, [5 x %struct.ap_fixed]* null, [5 x %struct.ap_fixed]* %27)
  ...
  %33 = bitcast [100000 x %struct.ap_fixed]* %19 to %struct.ap_fixed*
  %34 = bitcast [1000 x %struct.ap_fixed]* %20 to %struct.ap_fixed*
  %35 = bitcast [100000 x %struct.ap_fixed]* %21 to %struct.ap_fixed*
  %36 = bitcast [500 x %struct.ap_fixed]* %22 to %struct.ap_fixed*
  %37 = bitcast [17300 x %struct.ap_fixed]* %23 to %struct.ap_fixed*
  %38 = bitcast [6500 x %struct.ap_fixed]* %24 to %struct.ap_fixed*
  %39 = bitcast [100 x %struct.ap_fixed]* %25 to %struct.ap_fixed*
