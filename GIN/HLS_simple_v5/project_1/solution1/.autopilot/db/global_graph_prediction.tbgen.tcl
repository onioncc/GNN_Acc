...
set C_modelArgList {
	...
	{ graph_pred_bias_V_0 int 32 regular {pointer 0} {global 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "graph_pred_bias_V_0", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "graph_pred_bias.V","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 2}]}]}], "extern" : 0} , 
...
set portList { 
	...
	{ graph_pred_bias_V_0 sc_in sc_lv 32 signal 2 } 
	{ graph_embedding_V_address0 sc_out sc_lv 9 signal 3 } 
	{ graph_embedding_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ graph_embedding_V_q0 sc_in sc_lv 32 signal 3 } 
	{ graph_pred_weights_V_address0 sc_out sc_lv 9 signal 4 } 
	{ graph_pred_weights_V_ce0 sc_out sc_logic 1 signal 4 } 
	{ graph_pred_weights_V_q0 sc_in sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "graph_pred_bias_V_0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "graph_pred_bias_V_0", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_54_1_1_U12979", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	global_graph_prediction {
		...
		graph_pred_bias_V_0 {Type I LastRead 0 FirstWrite -1}
		graph_embedding_V {Type I LastRead 1 FirstWrite -1}
		graph_pred_weights_V {Type I LastRead 1 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	graph_pred_bias_V_0 { ap_none {  { graph_pred_bias_V_0 in_data 0 32 } } }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "graph_embedding_V", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "graph_pred_weights_V", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_54_1_1_U5195", "Parent" : "0"}]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "graph_embedding_V", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "graph_pred_weights_V", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_54_1_1_U7183", "Parent" : "0"}]}
