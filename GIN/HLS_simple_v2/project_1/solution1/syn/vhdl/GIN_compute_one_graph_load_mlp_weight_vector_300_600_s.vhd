...
entity GIN_compute_one_graph_load_mlp_weight_vector_300_600_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of GIN_compute_one_graph_load_mlp_weight_vector_300_600_s is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln77_2_fu_123_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal grp_fu_128_p0 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_fu_128_p1 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    add_ln74_fu_102_p2 <= std_logic_vector(unsigned(i_reg_87) + unsigned(ap_const_lv9_1));
    ...
    grp_fu_128_p0 <= grp_fu_128_p00(10 - 1 downto 0);
    grp_fu_128_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(d_out_dout),18));
    grp_fu_128_p1 <= ap_const_lv18_12C(10 - 1 downto 0);
    icmp_ln74_fu_108_p2 <= "1" when (i_reg_87 = ap_const_lv9_12C) else "0";
    mlp_1_weights_V_address0 <= zext_ln77_2_fu_123_p1(18 - 1 downto 0);
    ...
    mlp_weight_vector_din <= mlp_1_weights_V_q0;
    ...
    zext_ln77_2_fu_123_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln77_fu_118_p2),64));
