...
module GIN_compute_one_graph_MLP_PE_600_300_63 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        ap_idle,
        ap_ready,
        mlp_weight_fifo_5_V_V_dout,
        mlp_weight_fifo_5_V_V_empty_n,
        mlp_weight_fifo_5_V_V_read,
        mlp_weight_fifo_6_V_V_din,
        mlp_weight_fifo_6_V_V_full_n,
        mlp_weight_fifo_6_V_V_write,
...
output   ap_idle;
output   ap_ready;
input  [31:0] mlp_weight_fifo_5_V_V_dout;
input   mlp_weight_fifo_5_V_V_empty_n;
output   mlp_weight_fifo_5_V_V_read;
output  [31:0] mlp_weight_fifo_6_V_V_din;
input   mlp_weight_fifo_6_V_V_full_n;
output   mlp_weight_fifo_6_V_V_write;
...
reg ap_idle;
reg ap_ready;
reg mlp_weight_fifo_5_V_V_read;
reg mlp_weight_fifo_6_V_V_write;
reg mlp_2_bias_V_load_loc_read;
reg mlp_in_local5_ce0;
reg mlp_out_local20_ce0;
reg mlp_out_local20_we0;
reg d_out_read;
reg do_relu_read;
...
reg    mlp_weight_fifo_6_V_V_blk_n;
...
reg   [0:0] do_relu_11_reg_275;
reg   [8:0] mlp_out_local20_addr_reg_280;
...
wire   [30:0] r_V_12_fu_218_p1;
wire   [53:0] r_V_12_fu_218_p2;
wire   [53:0] lhs_12_fu_224_p3;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        mlp_out_local20_addr_reg_280 <= zext_ln85_fu_188_p1;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        mlp_in_local5_ce0 = 1'b1;
    end else begin
        mlp_in_local5_ce0 = 1'b0;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        mlp_out_local20_ce0 = 1'b1;
    end else begin
        mlp_out_local20_ce0 = 1'b0;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        mlp_out_local20_we0 = 1'b1;
    end else begin
        mlp_out_local20_we0 = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln86_reg_290 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        mlp_weight_fifo_5_V_V_read = 1'b1;
    end else begin
        mlp_weight_fifo_5_V_V_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln86_reg_290 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        mlp_weight_fifo_6_V_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((icmp_ln86_reg_290 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        mlp_weight_fifo_6_V_V_write = 1'b1;
    end else begin
        mlp_weight_fifo_6_V_V_write = 1'b0;
    end
end
...
assign and_ln92_fu_256_p2 = (tmp_fu_248_p3 & do_relu_11_reg_275);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln86_reg_290 == 1'd0) & (mlp_weight_fifo_6_V_V_full_n == 1'b0)) | ((icmp_ln86_reg_290 == 1'd0) & (mlp_weight_fifo_5_V_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln86_reg_290 == 1'd0) & (mlp_weight_fifo_6_V_V_full_n == 1'b0)) | ((icmp_ln86_reg_290 == 1'd0) & (mlp_weight_fifo_5_V_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln86_reg_290 == 1'd0) & (mlp_weight_fifo_6_V_V_full_n == 1'b0)) | ((icmp_ln86_reg_290 == 1'd0) & (mlp_weight_fifo_5_V_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (((icmp_ln86_reg_290 == 1'd0) & (mlp_weight_fifo_6_V_V_full_n == 1'b0)) | ((icmp_ln86_reg_290 == 1'd0) & (mlp_weight_fifo_5_V_V_empty_n == 1'b0)));
end
...
assign lhs_12_fu_224_p3 = {{lhs_reg_178}, {22'd0}};

assign mlp_2_bias_V_load_loc_out_din = mlp_2_bias_V_load_loc_dout;

assign mlp_in_local5_address0 = zext_ln86_fu_205_p1;

assign mlp_out_local20_address0 = mlp_out_local20_addr_reg_280;

assign mlp_out_local20_d0 = ((and_ln92_fu_256_p2[0:0] == 1'b1) ? 32'd0 : lhs_reg_178);

assign mlp_weight_fifo_6_V_V_din = mlp_weight_fifo_5_V_V_dout;

assign r_V_12_fu_218_p1 = r_V_12_fu_218_p10;

assign r_V_12_fu_218_p10 = mlp_in_local5_q0;

assign ret_V_fu_232_p2 = (r_V_12_fu_218_p2 + lhs_12_fu_224_p3);
...
endmodule //GIN_compute_one_graph_MLP_PE_600_300_63
