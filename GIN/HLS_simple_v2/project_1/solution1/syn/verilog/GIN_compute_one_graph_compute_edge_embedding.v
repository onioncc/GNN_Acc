...
wire   [33:0] add_ln217_1_fu_287_p2;
reg   [33:0] add_ln217_1_reg_538;
wire    ap_CS_fsm_state4;
wire   [1:0] select_ln217_fu_332_p3;
reg   [1:0] select_ln217_reg_546;
wire   [0:0] icmp_ln217_fu_315_p2;
wire   [31:0] select_ln217_1_fu_340_p3;
reg   [31:0] select_ln217_1_reg_552;
wire   [6:0] empty_98_fu_397_p1;
reg   [6:0] empty_98_reg_567;
wire    ap_CS_fsm_state5;
wire  signed [19:0] grp_fu_503_p2;
reg  signed [19:0] mul_ln703_reg_572;
wire    ap_CS_fsm_state7;
wire   [1:0] add_ln204_fu_401_p2;
wire    ap_CS_fsm_pp1_stage0;
reg    ap_enable_reg_pp1_iter0;
wire    ap_block_state8_pp1_stage0_iter0;
wire    ap_block_state9_pp1_stage0_iter1;
wire    ap_block_pp1_stage0_11001;
wire   [0:0] icmp_ln204_fu_407_p2;
reg   [0:0] icmp_ln204_reg_582;
wire   [3:0] addr_2_fu_421_p2;
reg    ap_enable_reg_pp1_iter1;
wire   [14:0] mul_ln220_fu_445_p2;
reg   [14:0] mul_ln220_reg_596;
wire    ap_CS_fsm_state10;
wire   [8:0] add_ln220_fu_451_p2;
wire    ap_CS_fsm_pp2_stage0;
reg    ap_enable_reg_pp2_iter0;
wire    ap_block_state11_pp2_stage0_iter0;
wire    ap_block_state12_pp2_stage0_iter1;
wire    ap_block_pp2_stage0_11001;
wire   [0:0] icmp_ln220_fu_457_p2;
reg   [0:0] icmp_ln220_reg_606;
reg   [19:0] edge_embedding_V_addr_1_reg_610;
wire   [1:0] add_ln218_fu_498_p2;
...
wire   [10:0] empty_93_fu_297_p1;
wire   [12:0] p_shl_fu_301_p3;
wire   [12:0] trunc_ln217_fu_293_p1;
wire   [0:0] icmp_ln218_fu_326_p2;
wire   [31:0] add_ln217_fu_320_p2;
wire   [10:0] empty_97_fu_356_p1;
wire   [12:0] p_shl_mid1_fu_360_p3;
wire   [12:0] trunc_ln217_1_fu_352_p1;
wire   [12:0] p_mid1_fu_368_p2;
wire   [12:0] empty_94_fu_309_p2;
wire   [12:0] select_ln217_2_fu_374_p3;
wire   [12:0] zext_ln218_fu_382_p1;
wire   [12:0] add_ln219_fu_386_p2;
wire   [3:0] ed_feature_table_1_load_cast_fu_417_p1;
wire   [6:0] addr_cast_fu_427_p1;
wire   [6:0] tmp_fu_431_p2;
wire   [6:0] add3_fu_436_p2;
wire   [6:0] mul_ln220_fu_445_p0;
wire   [9:0] mul_ln220_fu_445_p1;
wire   [19:0] zext_ln703_7_fu_467_p1;
(* use_dsp48 = "no" *) wire   [19:0] add_ln703_7_fu_471_p2;
wire   [14:0] zext_ln703_fu_463_p1;
wire   [14:0] add_ln223_fu_481_p2;
...
reg    ap_idle_pp2;
wire    ap_enable_pp2;
wire   [14:0] mul_ln220_fu_445_p00;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        addr_reg_222 <= 4'd0;
    end else if (((1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (icmp_ln204_reg_582 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        addr_reg_222 <= addr_2_fu_421_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp2_stage0) & (icmp_ln220_fu_457_p2 == 1'd0) & (ap_enable_reg_pp2_iter0 == 1'b1) & (1'b0 == ap_block_pp2_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond728_fu_255_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        i_reg_211 <= 2'd0;
    end else if (((1'b1 == ap_CS_fsm_pp1_stage0) & (icmp_ln204_fu_407_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp2_stage0) & (icmp_ln220_fu_457_p2 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln217_fu_315_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if ((icmp_ln204_fu_407_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((icmp_ln220_fu_457_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((((icmp_ln217_fu_315_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4)) | ((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln217_fu_315_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((((ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0) & (icmp_ln220_reg_606 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001)) | ((exitcond728_fu_255_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((icmp_ln204_fu_407_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((icmp_ln204_fu_407_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        ...
        ap_ST_fsm_pp2_stage0 : begin
            if (~((icmp_ln220_fu_457_p2 == 1'd1) & (ap_enable_reg_pp2_iter0 == 1'b1) & (1'b0 == ap_block_pp2_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp2_stage0;
            end else if (((icmp_ln220_fu_457_p2 == 1'd1) & (ap_enable_reg_pp2_iter0 == 1'b1) & (1'b0 == ap_block_pp2_stage0_subdone))) begin
...
assign add3_fu_436_p2 = (tmp_fu_431_p2 + empty_98_reg_567);

assign add_ln204_fu_401_p2 = (i_reg_211 + 2'd1);

assign add_ln217_1_fu_287_p2 = (indvar_flatten_reg_178 + 34'd1);

assign add_ln217_fu_320_p2 = (e_reg_189 + 32'd1);

assign add_ln218_fu_498_p2 = (select_ln217_reg_546 + 2'd1);

assign add_ln219_fu_386_p2 = (select_ln217_2_fu_374_p3 + zext_ln218_fu_382_p1);

assign add_ln220_fu_451_p2 = (dim_reg_234 + 9'd1);

assign add_ln223_fu_481_p2 = (mul_ln220_reg_596 + zext_ln703_fu_463_p1);
...
assign edge_attr_address0 = zext_ln219_fu_392_p1;

assign edge_embedding_V_address0 = zext_ln703_8_fu_476_p1;

assign edge_embedding_table_V_address0 = zext_ln223_fu_486_p1;

assign empty_91_fu_249_p2 = (empty_reg_167 + 20'd1);

assign empty_93_fu_297_p1 = e_reg_189[10:0];

assign empty_94_fu_309_p2 = (p_shl_fu_301_p3 - trunc_ln217_fu_293_p1);

assign empty_97_fu_356_p1 = add_ln217_fu_320_p2[10:0];

assign empty_98_fu_397_p1 = edge_attr_q0[6:0];

assign exitcond728_fu_255_p2 = ((empty_reg_167 == 20'd600000) ? 1'b1 : 1'b0);

assign grp_fu_503_p0 = select_ln217_1_fu_340_p3[19:0];

assign grp_fu_503_p1 = 20'd300;

assign i_cast_fu_412_p1 = i_reg_211;

assign icmp_ln204_fu_407_p2 = ((i_reg_211 == select_ln217_reg_546) ? 1'b1 : 1'b0);

assign icmp_ln217_fu_315_p2 = ((indvar_flatten_reg_178 == bound_reg_533) ? 1'b1 : 1'b0);

assign icmp_ln218_fu_326_p2 = ((ef_reg_200 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln220_fu_457_p2 = ((dim_reg_234 == 9'd300) ? 1'b1 : 1'b0);
...
assign mul_ln220_fu_445_p0 = mul_ln220_fu_445_p00;

assign mul_ln220_fu_445_p00 = add3_fu_436_p2;

assign mul_ln220_fu_445_p1 = 15'd300;

assign p_cast_fu_261_p1 = empty_reg_167;

assign p_mid1_fu_368_p2 = (p_shl_mid1_fu_360_p3 - trunc_ln217_1_fu_352_p1);

assign p_shl2_fu_274_p3 = {{num_of_edges}, {2'd0}};

assign p_shl_fu_301_p3 = {{empty_93_fu_297_p1}, {2'd0}};

assign p_shl_mid1_fu_360_p3 = {{empty_97_fu_356_p1}, {2'd0}};

assign select_ln217_1_fu_340_p3 = ((icmp_ln218_fu_326_p2[0:0] == 1'b1) ? add_ln217_fu_320_p2 : e_reg_189);

assign select_ln217_2_fu_374_p3 = ((icmp_ln218_fu_326_p2[0:0] == 1'b1) ? p_mid1_fu_368_p2 : empty_94_fu_309_p2);

assign select_ln217_fu_332_p3 = ((icmp_ln218_fu_326_p2[0:0] == 1'b1) ? 2'd0 : ef_reg_200);

assign tmp_fu_431_p2 = (mul_i_reg_528 + addr_cast_fu_427_p1);

assign trunc_ln217_1_fu_352_p1 = add_ln217_fu_320_p2[12:0];

assign trunc_ln217_fu_293_p1 = e_reg_189[12:0];

assign zext_ln218_fu_382_p1 = select_ln217_fu_332_p3;

assign zext_ln219_fu_392_p1 = add_ln219_fu_386_p2;

assign zext_ln223_fu_486_p1 = add_ln223_fu_481_p2;
