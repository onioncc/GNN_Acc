...
set id 94
set name GIN_compute_one_graph_urem_12ns_11ns_12_16_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { mlp_in_local3_address0 { O 10 vector } mlp_in_local3_ce0 { O 1 bit } mlp_in_local3_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { mlp_1_weight_fifo_3_V_V_dout { I 32 vector } mlp_1_weight_fifo_3_V_V_empty_n { I 1 bit } mlp_1_weight_fifo_3_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mlp_out_local6 \
    op interface \
    ports { mlp_out_local6 { O 31 vector } mlp_out_local6_ap_vld { O 1 bit } } \
} "
}
