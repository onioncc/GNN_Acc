...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { mlp_in_local_address0 { O 10 vector } mlp_in_local_ce0 { O 1 bit } mlp_in_local_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mlp_out_local \
    op interface \
    ports { mlp_out_local { O 31 vector } mlp_out_local_ap_vld { O 1 bit } } \
} "
}
