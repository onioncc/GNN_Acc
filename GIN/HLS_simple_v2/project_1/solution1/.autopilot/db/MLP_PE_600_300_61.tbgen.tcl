set moduleName MLP_PE_600_300_61
set isTopModule 0
...
set C_modelName {MLP_PE<600, 300>61}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_31ns_54_1_1_U346", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	mlp_in_local3 { ap_memory {  { mlp_in_local3_address0 mem_address 1 10 }  { mlp_in_local3_ce0 mem_ce 1 1 }  { mlp_in_local3_q0 mem_dout 0 31 } } }
	mlp_out_local18 { ap_memory {  { mlp_out_local18_address0 mem_address 1 9 }  { mlp_out_local18_ce0 mem_ce 1 1 }  { mlp_out_local18_we0 mem_we 1 1 }  { mlp_out_local18_d0 mem_din 1 32 } } }
