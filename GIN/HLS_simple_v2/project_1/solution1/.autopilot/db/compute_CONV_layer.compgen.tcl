...
set ID 605
set hasByteEnable 0
set MemName GIN_compute_one_graph_compute_CONV_layer_edge_embedding_V
set CoreName ap_simcore_mem
set PortList { 1 0 }
set DataWd 32
set AddrRange 600000
set AddrWd 20
...
set ID 607
set hasByteEnable 0
set MemName GIN_compute_one_graph_compute_CONV_layer_mlp_1_bias_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 600
...
set ID 608
set hasByteEnable 0
set MemName GIN_compute_one_graph_compute_CONV_layer_mlp_1_weights_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 180000
set AddrWd 18
set impl_style auto
set TrueReset 0
set IsROM 0
...
set ID 609
set hasByteEnable 0
set MemName GIN_compute_one_graph_compute_CONV_layer_mlp_2_bias_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 300
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 618 \
    name edge_embedding_table_V \
    reset_level 1 \
    sync_rst true \
    dir I \
    corename edge_embedding_table_V \
    op interface \
    ports { edge_embedding_table_V_address0 { O 15 vector } edge_embedding_table_V_ce0 { O 1 bit } edge_embedding_table_V_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'edge_embedding_table_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename edge_attr \
    op interface \
    ports { edge_attr_address0 { O 13 vector } edge_attr_ce0 { O 1 bit } edge_attr_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename edge_list \
    op interface \
    ports { edge_list_address0 { O 12 vector } edge_list_ce0 { O 1 bit } edge_list_q0 { I 32 vector } edge_list_address1 { O 12 vector } edge_list_ce1 { O 1 bit } edge_list_q1 { I 32 vector } } \
} "
} else {
