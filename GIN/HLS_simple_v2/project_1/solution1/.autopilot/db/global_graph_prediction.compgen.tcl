...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 633 \
    name graph_pred_bias_V \
    reset_level 1 \
    sync_rst true \
    dir I \
    corename graph_pred_bias_V \
    op interface \
    ports { graph_pred_bias_V_address0 { O 1 vector } graph_pred_bias_V_ce0 { O 1 bit } graph_pred_bias_V_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'graph_pred_bias_V'"
}
}
