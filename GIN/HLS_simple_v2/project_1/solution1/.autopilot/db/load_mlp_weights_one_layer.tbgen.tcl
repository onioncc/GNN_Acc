set moduleName load_mlp_weights_one_layer
set isTopModule 0
...
set C_modelName {load_mlp_weights_one_layer}
...
set C_modelArgList {
	...
	{ mlp_1_bias_V int 32 regular {array 600 { 0 3 } 0 1 } {global 1}  }
	{ mlp_1_weights_V int 32 regular {array 180000 { 0 3 } 0 1 } {global 1}  }
	{ mlp_2_bias_V int 32 regular {array 300 { 0 3 } 0 1 } {global 1}  }
	{ mlp_2_weights_V int 32 regular {array 180000 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "mlp_1_bias_V", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "mlp_1_bias.V","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 599,"step" : 1}]}]}], "extern" : 0} , 
 	{ "Name" : "mlp_1_weights_V", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "mlp_1_weights.V","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 599,"step" : 1},{"low" : 0,"up" : 299,"step" : 1}]}]}], "extern" : 0} , 
 	{ "Name" : "mlp_2_bias_V", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "mlp_2_bias.V","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 299,"step" : 1}]}]}], "extern" : 0} , 
 	{ "Name" : "mlp_2_weights_V", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "mlp_2_weights.V","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 299,"step" : 1},{"low" : 0,"up" : 599,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ gnn_node_mlp_1_weights_fixed sc_in sc_lv 64 signal 2 } 
	{ gnn_node_mlp_1_bias_fixed sc_in sc_lv 64 signal 3 } 
	{ gnn_node_mlp_2_weights_fixed sc_in sc_lv 64 signal 4 } 
	{ gnn_node_mlp_2_bias_fixed sc_in sc_lv 64 signal 5 } 
	{ mlp_1_bias_V_address0 sc_out sc_lv 10 signal 6 } 
	{ mlp_1_bias_V_ce0 sc_out sc_logic 1 signal 6 } 
	{ mlp_1_bias_V_we0 sc_out sc_logic 1 signal 6 } 
	{ mlp_1_bias_V_d0 sc_out sc_lv 32 signal 6 } 
	{ mlp_1_weights_V_address0 sc_out sc_lv 18 signal 7 } 
	{ mlp_1_weights_V_ce0 sc_out sc_logic 1 signal 7 } 
	{ mlp_1_weights_V_we0 sc_out sc_logic 1 signal 7 } 
	{ mlp_1_weights_V_d0 sc_out sc_lv 32 signal 7 } 
	{ mlp_2_bias_V_address0 sc_out sc_lv 9 signal 8 } 
	{ mlp_2_bias_V_ce0 sc_out sc_logic 1 signal 8 } 
	{ mlp_2_bias_V_we0 sc_out sc_logic 1 signal 8 } 
	{ mlp_2_bias_V_d0 sc_out sc_lv 32 signal 8 } 
	{ mlp_2_weights_V_address0 sc_out sc_lv 18 signal 9 } 
	{ mlp_2_weights_V_ce0 sc_out sc_logic 1 signal 9 } 
	{ mlp_2_weights_V_we0 sc_out sc_logic 1 signal 9 } 
	{ mlp_2_weights_V_d0 sc_out sc_lv 32 signal 9 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_3ns_11ns_13_1_1_U43", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_3ns_19ns_21_1_1_U44", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_3ns_10ns_12_1_1_U45", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "371702", "Max" : "371702"}
	, {"Name" : "Interval", "Min" : "371702", "Max" : "371702"}
]}
...
set Spec2ImplPortList { 
	...
	mlp_1_bias_V { ap_memory {  { mlp_1_bias_V_address0 mem_address 1 10 }  { mlp_1_bias_V_ce0 mem_ce 1 1 }  { mlp_1_bias_V_we0 mem_we 1 1 }  { mlp_1_bias_V_d0 mem_din 1 32 } } }
	mlp_1_weights_V { ap_memory {  { mlp_1_weights_V_address0 mem_address 1 18 }  { mlp_1_weights_V_ce0 mem_ce 1 1 }  { mlp_1_weights_V_we0 mem_we 1 1 }  { mlp_1_weights_V_d0 mem_din 1 32 } } }
	mlp_2_bias_V { ap_memory {  { mlp_2_bias_V_address0 mem_address 1 9 }  { mlp_2_bias_V_ce0 mem_ce 1 1 }  { mlp_2_bias_V_we0 mem_we 1 1 }  { mlp_2_bias_V_d0 mem_din 1 32 } } }
	mlp_2_weights_V { ap_memory {  { mlp_2_weights_V_address0 mem_address 1 18 }  { mlp_2_weights_V_ce0 mem_ce 1 1 }  { mlp_2_weights_V_we0 mem_we 1 1 }  { mlp_2_weights_V_d0 mem_din 1 32 } } }
}
