set moduleName load_mlp_weight_vector
set isTopModule 0
...
set C_modelName {load_mlp_weight_vector}
set C_modelType { void 0 }
set C_modelArgList {
	{ mlp_1_weight_vector int 32 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mlp_1_weight_vector", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ mlp_1_weight_vector_din sc_out sc_lv 32 signal 0 } 
	{ mlp_1_weight_vector_full_n sc_in sc_logic 1 signal 0 } 
	{ mlp_1_weight_vector_write sc_out sc_logic 1 signal 0 } 
	{ d_out_dout sc_in sc_lv 10 signal 1 } 
	{ d_out_empty_n sc_in sc_logic 1 signal 1 } 
	{ d_out_read sc_out sc_logic 1 signal 1 } 
	{ d_out_out_din sc_out sc_lv 10 signal 2 } 
	{ d_out_out_full_n sc_in sc_logic 1 signal 2 } 
	{ d_out_out_write sc_out sc_logic 1 signal 2 } 
	{ mlp_1_weights_V_address0 sc_out sc_lv 18 signal 3 } 
	{ mlp_1_weights_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ mlp_1_weights_V_q0 sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mlp_1_weight_vector_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mlp_1_weight_vector", "role": "din" }} , 
 	{ "name": "mlp_1_weight_vector_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mlp_1_weight_vector", "role": "full_n" }} , 
 	{ "name": "mlp_1_weight_vector_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mlp_1_weight_vector", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "mlp_1_weight_vector", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_10ns_10ns_18_4_1_U62", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	mlp_1_weight_vector { ap_fifo {  { mlp_1_weight_vector_din fifo_data 1 32 }  { mlp_1_weight_vector_full_n fifo_status 0 1 }  { mlp_1_weight_vector_write fifo_update 1 1 } } }
...
set portList { 
	...
	{ d_out_empty_n sc_in sc_logic 1 signal 1 } 
	{ d_out_read sc_out sc_logic 1 signal 1 } 
	{ mlp_1_weights_V_address0 sc_out sc_lv 18 signal 2 } 
	{ mlp_1_weights_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ mlp_1_weights_V_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	{ "name": "ap_rst", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "reset", "bundle":{"name": "ap_rst", "role": "default" }} , 
