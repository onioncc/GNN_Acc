...
set id 10
set name GIN_compute_one_graph_mul_8ns_10ns_16_1_1
...
set id 11
set name GIN_compute_one_graph_mul_mul_19s_10ns_19_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set out_width 19
set exp i0*i1
set arg_lists {i0 {19 1 +} i1 {10 0 +} p {19 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { node_feature_address0 { O 14 vector } node_feature_ce0 { O 1 bit } node_feature_q0 { I 32 vector } } \
} "
} else {
