set moduleName MLP_PE_600_300_60
set isTopModule 0
...
set C_modelName {MLP_PE<600, 300>60}
...
set portList { 
	...
	{ mlp_in_local2_address0 sc_out sc_lv 10 signal 3 } 
	{ mlp_in_local2_ce0 sc_out sc_logic 1 signal 3 } 
	{ mlp_in_local2_q0 sc_in sc_lv 31 signal 3 } 
	{ mlp_out_local17_address0 sc_out sc_lv 9 signal 4 } 
	{ mlp_out_local17_ce0 sc_out sc_logic 1 signal 4 } 
	{ mlp_out_local17_we0 sc_out sc_logic 1 signal 4 } 
	{ mlp_out_local17_d0 sc_out sc_lv 32 signal 4 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_31ns_54_1_1_U335", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	mlp_in_local2 { ap_memory {  { mlp_in_local2_address0 mem_address 1 10 }  { mlp_in_local2_ce0 mem_ce 1 1 }  { mlp_in_local2_q0 mem_dout 0 31 } } }
	mlp_out_local17 { ap_memory {  { mlp_out_local17_address0 mem_address 1 9 }  { mlp_out_local17_ce0 mem_ce 1 1 }  { mlp_out_local17_we0 mem_we 1 1 }  { mlp_out_local17_d0 mem_din 1 32 } } }
