...
set portList { 
	...
	{ mlp_1_weight_fifo_0_V_V_dout sc_in sc_lv 32 signal 1 } 
	{ mlp_1_weight_fifo_0_V_V_empty_n sc_in sc_logic 1 signal 1 } 
	{ mlp_1_weight_fifo_0_V_V_read sc_out sc_logic 1 signal 1 } 
	{ mlp_1_weight_fifo_1_V_V_din sc_out sc_lv 32 signal 2 } 
	{ mlp_1_weight_fifo_1_V_V_full_n sc_in sc_logic 1 signal 2 } 
	{ mlp_1_weight_fifo_1_V_V_write sc_out sc_logic 1 signal 2 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_54_1_1_U70", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	mlp_in_local { ap_memory {  { mlp_in_local_address0 mem_address 1 10 }  { mlp_in_local_ce0 mem_ce 1 1 }  { mlp_in_local_q0 mem_dout 0 32 } } }
