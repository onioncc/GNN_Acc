...
set C_modelArgList {
	...
	{ node_feature int 32 regular {array 9000 { 3 0 } 0 1 } {global 1}  }
	{ edge_attr int 32 regular {array 6000 { 3 0 } 0 1 } {global 1}  }
	{ edge_list int 32 regular {array 4000 { 3 0 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "node_feature", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "node_feature","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 8999,"step" : 1}]}]}], "extern" : 0} , 
 	{ "Name" : "edge_attr", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "edge_attr","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 5999,"step" : 1}]}]}], "extern" : 0} , 
 	{ "Name" : "edge_list", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "edge_list","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3999,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ num_of_edges sc_in sc_lv 32 signal 5 } 
	{ node_feature_address1 sc_out sc_lv 14 signal 6 } 
	{ node_feature_ce1 sc_out sc_logic 1 signal 6 } 
	{ node_feature_we1 sc_out sc_logic 1 signal 6 } 
	{ node_feature_d1 sc_out sc_lv 32 signal 6 } 
	{ edge_attr_address1 sc_out sc_lv 13 signal 7 } 
	{ edge_attr_ce1 sc_out sc_logic 1 signal 7 } 
	{ edge_attr_we1 sc_out sc_logic 1 signal 7 } 
	{ edge_attr_d1 sc_out sc_lv 32 signal 7 } 
	{ edge_list_address1 sc_out sc_lv 12 signal 8 } 
	{ edge_list_ce1 sc_out sc_logic 1 signal 8 } 
	{ edge_list_we1 sc_out sc_logic 1 signal 8 } 
	{ edge_list_d1 sc_out sc_lv 32 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "node_feature_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "node_feature", "role": "address1" }} , 
 	...
 	{ "name": "edge_attr_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "edge_attr", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	...
	node_feature { ap_memory {  { node_feature_address1 MemPortADDR2 1 14 }  { node_feature_ce1 MemPortCE2 1 1 }  { node_feature_we1 MemPortWE2 1 1 }  { node_feature_d1 MemPortDIN2 1 32 } } }
	edge_attr { ap_memory {  { edge_attr_address1 MemPortADDR2 1 13 }  { edge_attr_ce1 MemPortCE2 1 1 }  { edge_attr_we1 MemPortWE2 1 1 }  { edge_attr_d1 MemPortDIN2 1 32 } } }
	edge_list { ap_memory {  { edge_list_address1 MemPortADDR2 1 12 }  { edge_list_ce1 MemPortCE2 1 1 }  { edge_list_we1 MemPortWE2 1 1 }  { edge_list_d1 MemPortDIN2 1 32 } } }
}
