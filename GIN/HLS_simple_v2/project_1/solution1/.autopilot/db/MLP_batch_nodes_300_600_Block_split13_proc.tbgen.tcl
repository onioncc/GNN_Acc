set moduleName MLP_batch_nodes_300_600_Block_split13_proc
set isTopModule 0
...
set C_modelName {MLP_batch_nodes<300, 600>_Block_.split13_proc}
set C_modelType { void 0 }
set C_modelArgList {
	{ d_out int 10 regular {fifo 0}  }
	{ mlp_1_bias_V_load_out_out int 32 regular {fifo 1}  }
	{ mlp_1_bias_V int 32 regular {array 600 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "d_out", "interface" : "fifo", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "mlp_1_bias_V_load_out_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ d_out_dout sc_in sc_lv 10 signal 0 } 
	{ d_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ d_out_read sc_out sc_logic 1 signal 0 } 
	{ mlp_1_bias_V_load_out_out_din sc_out sc_lv 32 signal 1 } 
	{ mlp_1_bias_V_load_out_out_full_n sc_in sc_logic 1 signal 1 } 
	{ mlp_1_bias_V_load_out_out_write sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mlp_1_bias_V_load_out_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mlp_1_bias_V_load_out_out", "role": "din" }} , 
 	{ "name": "mlp_1_bias_V_load_out_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mlp_1_bias_V_load_out_out", "role": "full_n" }} , 
 	{ "name": "mlp_1_bias_V_load_out_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mlp_1_bias_V_load_out_out", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "mlp_1_bias_V_load_out_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	mlp_1_bias_V_load_out_out { ap_fifo {  { mlp_1_bias_V_load_out_out_din fifo_data 1 32 }  { mlp_1_bias_V_load_out_out_full_n fifo_status 0 1 }  { mlp_1_bias_V_load_out_out_write fifo_update 1 1 } } }
