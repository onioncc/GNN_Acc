set moduleName MLP_PE_600_300_73
set isTopModule 0
...
set C_modelName {MLP_PE<600, 300>73}
...
set portList { 
	...
	{ mlp_2_bias_V_load_loc_dout sc_in sc_lv 32 signal 1 } 
	{ mlp_2_bias_V_load_loc_empty_n sc_in sc_logic 1 signal 1 } 
	{ mlp_2_bias_V_load_loc_read sc_out sc_logic 1 signal 1 } 
	{ mlp_in_local15_address0 sc_out sc_lv 10 signal 2 } 
	{ mlp_in_local15_ce0 sc_out sc_logic 1 signal 2 } 
	{ mlp_in_local15_q0 sc_in sc_lv 31 signal 2 } 
	{ mlp_out_local30_address0 sc_out sc_lv 9 signal 3 } 
	{ mlp_out_local30_ce0 sc_out sc_logic 1 signal 3 } 
	{ mlp_out_local30_we0 sc_out sc_logic 1 signal 3 } 
	{ mlp_out_local30_d0 sc_out sc_lv 32 signal 3 } 
	{ d_out_dout sc_in sc_lv 9 signal 4 } 
	{ d_out_empty_n sc_in sc_logic 1 signal 4 } 
	{ d_out_read sc_out sc_logic 1 signal 4 } 
	{ do_relu_dout sc_in sc_lv 1 signal 5 } 
	{ do_relu_empty_n sc_in sc_logic 1 signal 5 } 
	{ do_relu_read sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_31ns_54_1_1_U478", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	mlp_in_local15 { ap_memory {  { mlp_in_local15_address0 mem_address 1 10 }  { mlp_in_local15_ce0 mem_ce 1 1 }  { mlp_in_local15_q0 mem_dout 0 31 } } }
	mlp_out_local30 { ap_memory {  { mlp_out_local30_address0 mem_address 1 9 }  { mlp_out_local30_ce0 mem_ce 1 1 }  { mlp_out_local30_we0 mem_we 1 1 }  { mlp_out_local30_d0 mem_din 1 32 } } }
