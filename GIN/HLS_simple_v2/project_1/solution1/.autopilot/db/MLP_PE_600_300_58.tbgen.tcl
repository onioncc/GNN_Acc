set moduleName MLP_PE_600_300_58
set isTopModule 0
...
set C_modelName {MLP_PE<600, 300>58}
...
set portList { 
	...
	{ mlp_in_local_address0 sc_out sc_lv 10 signal 3 } 
	{ mlp_in_local_ce0 sc_out sc_logic 1 signal 3 } 
	{ mlp_in_local_q0 sc_in sc_lv 31 signal 3 } 
	{ mlp_out_local_address0 sc_out sc_lv 9 signal 4 } 
	{ mlp_out_local_ce0 sc_out sc_logic 1 signal 4 } 
	{ mlp_out_local_we0 sc_out sc_logic 1 signal 4 } 
	{ mlp_out_local_d0 sc_out sc_lv 32 signal 4 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "do_relu", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_31ns_54_1_1_U312", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	mlp_in_local { ap_memory {  { mlp_in_local_address0 mem_address 1 10 }  { mlp_in_local_ce0 mem_ce 1 1 }  { mlp_in_local_q0 mem_dout 0 31 } } }
	mlp_out_local { ap_memory {  { mlp_out_local_address0 mem_address 1 9 }  { mlp_out_local_ce0 mem_ce 1 1 }  { mlp_out_local_we0 mem_we 1 1 }  { mlp_out_local_d0 mem_din 1 32 } } }
