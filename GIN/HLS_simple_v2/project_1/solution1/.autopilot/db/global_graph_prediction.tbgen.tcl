set moduleName global_graph_prediction
set isTopModule 0
...
set C_modelName {global_graph_prediction}
set C_modelType { void 0 }
set C_modelArgList {
	{ mem int 32 regular {axi_master 1}  }
	{ d_out int 64 regular  }
	{ graph_embedding_V int 32 regular {array 300 { 1 3 } 1 1 } {global 0}  }
	{ graph_pred_weights_V int 32 regular {array 300 { 1 3 } 1 1 } {global 0}  }
	{ graph_pred_bias_V int 32 regular {array 1 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "d_out", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "graph_embedding_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "graph_embedding.V","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 299,"step" : 1}]}]}], "extern" : 0} , 
 	{ "Name" : "graph_pred_weights_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "graph_pred_weights.V","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 299,"step" : 1}]}]}], "extern" : 0} , 
 	{ "Name" : "graph_pred_bias_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "graph_pred_bias.V","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ d_out sc_in sc_lv 64 signal 1 } 
	{ graph_embedding_V_address0 sc_out sc_lv 9 signal 2 } 
	{ graph_embedding_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ graph_embedding_V_q0 sc_in sc_lv 32 signal 2 } 
	{ graph_pred_weights_V_address0 sc_out sc_lv 9 signal 3 } 
	{ graph_pred_weights_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ graph_pred_weights_V_q0 sc_in sc_lv 32 signal 3 } 
	{ graph_pred_bias_V_address0 sc_out sc_lv 1 signal 4 } 
	{ graph_pred_bias_V_ce0 sc_out sc_logic 1 signal 4 } 
	{ graph_pred_bias_V_q0 sc_in sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "d_out", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "d_out", "role": "default" }} , 
 	{ "name": "graph_embedding_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "graph_embedding_V", "role": "address0" }} , 
 	{ "name": "graph_embedding_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "graph_embedding_V", "role": "ce0" }} , 
 	{ "name": "graph_embedding_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "graph_embedding_V", "role": "q0" }} , 
 	...
 	{ "name": "graph_pred_weights_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "graph_pred_weights_V", "role": "q0" }} , 
 	{ "name": "graph_pred_bias_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "graph_pred_bias_V", "role": "address0" }} , 
 	{ "name": "graph_pred_bias_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "graph_pred_bias_V", "role": "ce0" }} , 
 	{ "name": "graph_pred_bias_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "graph_pred_bias_V", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_54_1_1_U168", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	d_out { ap_none {  { d_out in_data 0 64 } } }
	graph_embedding_V { ap_memory {  { graph_embedding_V_address0 mem_address 1 9 }  { graph_embedding_V_ce0 mem_ce 1 1 }  { graph_embedding_V_q0 mem_dout 0 32 } } }
	graph_pred_weights_V { ap_memory {  { graph_pred_weights_V_address0 mem_address 1 9 }  { graph_pred_weights_V_ce0 mem_ce 1 1 }  { graph_pred_weights_V_q0 mem_dout 0 32 } } }
	graph_pred_bias_V { ap_memory {  { graph_pred_bias_V_address0 mem_address 1 1 }  { graph_pred_bias_V_ce0 mem_ce 1 1 }  { graph_pred_bias_V_q0 mem_dout 0 32 } } }
}
set moduleName global_graph_prediction
set isTopModule 0
set isCombinational 0
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "graph_pred_weights_V", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "graph_pred_bias_V", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_54_1_1_U173", "Parent" : "0"}]}
