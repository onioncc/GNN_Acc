set moduleName MLP_PE_300_600_42
set isTopModule 0
...
set C_modelName {MLP_PE<300, 600>42}
set C_modelType { void 0 }
set C_modelArgList {
	{ mlp_weight_fifo_0_V_V int 32 regular {fifo 0 volatile }  }
	{ mlp_weight_fifo_1_V_V int 32 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mlp_weight_fifo_0_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "mlp_weight_fifo_1_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ mlp_weight_fifo_0_V_V_dout sc_in sc_lv 32 signal 0 } 
	{ mlp_weight_fifo_0_V_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ mlp_weight_fifo_0_V_V_read sc_out sc_logic 1 signal 0 } 
	{ mlp_weight_fifo_1_V_V_din sc_out sc_lv 32 signal 1 } 
	{ mlp_weight_fifo_1_V_V_full_n sc_in sc_logic 1 signal 1 } 
	{ mlp_weight_fifo_1_V_V_write sc_out sc_logic 1 signal 1 } 
	...
	{ mlp_in_local_address0 sc_out sc_lv 9 signal 3 } 
	{ mlp_in_local_ce0 sc_out sc_logic 1 signal 3 } 
	{ mlp_in_local_q0 sc_in sc_lv 32 signal 3 } 
	{ mlp_out_local_address0 sc_out sc_lv 10 signal 4 } 
	{ mlp_out_local_ce0 sc_out sc_logic 1 signal 4 } 
	{ mlp_out_local_we0 sc_out sc_logic 1 signal 4 } 
	{ mlp_out_local_d0 sc_out sc_lv 31 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mlp_weight_fifo_0_V_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mlp_weight_fifo_0_V_V", "role": "dout" }} , 
 	{ "name": "mlp_weight_fifo_0_V_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mlp_weight_fifo_0_V_V", "role": "empty_n" }} , 
 	{ "name": "mlp_weight_fifo_0_V_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mlp_weight_fifo_0_V_V", "role": "read" }} , 
 	{ "name": "mlp_weight_fifo_1_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mlp_weight_fifo_1_V_V", "role": "din" }} , 
 	{ "name": "mlp_weight_fifo_1_V_V_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mlp_weight_fifo_1_V_V", "role": "full_n" }} , 
 	{ "name": "mlp_weight_fifo_1_V_V_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mlp_weight_fifo_1_V_V", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "mlp_weight_fifo_0_V_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "mlp_weight_fifo_0_V_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mlp_weight_fifo_1_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_54_1_1_U71", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	mlp_weight_fifo_0_V_V { ap_fifo {  { mlp_weight_fifo_0_V_V_dout fifo_data 0 32 }  { mlp_weight_fifo_0_V_V_empty_n fifo_status 0 1 }  { mlp_weight_fifo_0_V_V_read fifo_update 1 1 } } }
	mlp_weight_fifo_1_V_V { ap_fifo {  { mlp_weight_fifo_1_V_V_din fifo_data 1 32 }  { mlp_weight_fifo_1_V_V_full_n fifo_status 0 1 }  { mlp_weight_fifo_1_V_V_write fifo_update 1 1 } } }
	...
	mlp_in_local { ap_memory {  { mlp_in_local_address0 mem_address 1 9 }  { mlp_in_local_ce0 mem_ce 1 1 }  { mlp_in_local_q0 mem_dout 0 32 } } }
	mlp_out_local { ap_memory {  { mlp_out_local_address0 mem_address 1 10 }  { mlp_out_local_ce0 mem_ce 1 1 }  { mlp_out_local_we0 mem_we 1 1 }  { mlp_out_local_d0 mem_din 1 31 } } }
