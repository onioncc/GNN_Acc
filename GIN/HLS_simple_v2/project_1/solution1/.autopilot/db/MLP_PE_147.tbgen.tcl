...
set portList { 
	...
	{ mlp_in_local2_address0 sc_out sc_lv 10 signal 0 } 
	{ mlp_in_local2_ce0 sc_out sc_logic 1 signal 0 } 
	{ mlp_in_local2_q0 sc_in sc_lv 32 signal 0 } 
	{ mlp_1_weight_fifo_2_V_V_dout sc_in sc_lv 32 signal 1 } 
	{ mlp_1_weight_fifo_2_V_V_empty_n sc_in sc_logic 1 signal 1 } 
	{ mlp_1_weight_fifo_2_V_V_read sc_out sc_logic 1 signal 1 } 
	{ mlp_1_weight_fifo_3_V_V_din sc_out sc_lv 32 signal 2 } 
	{ mlp_1_weight_fifo_3_V_V_full_n sc_in sc_logic 1 signal 2 } 
	{ mlp_1_weight_fifo_3_V_V_write sc_out sc_logic 1 signal 2 } 
	...
	{ mlp_out_local5 sc_out sc_lv 31 signal 4 } 
	{ mlp_out_local5_ap_vld sc_out sc_logic 1 outvld 4 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_11ns_11ns_11_15_1_U85", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_54_1_1_U86", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	mlp_in_local2 { ap_memory {  { mlp_in_local2_address0 mem_address 1 10 }  { mlp_in_local2_ce0 mem_ce 1 1 }  { mlp_in_local2_q0 mem_dout 0 32 } } }
