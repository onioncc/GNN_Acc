set moduleName MLP_PE_300_600_52
set isTopModule 0
...
set C_modelName {MLP_PE<300, 600>52}
...
set portList { 
	...
	{ mlp_in_local10_address0 sc_out sc_lv 9 signal 3 } 
	{ mlp_in_local10_ce0 sc_out sc_logic 1 signal 3 } 
	{ mlp_in_local10_q0 sc_in sc_lv 32 signal 3 } 
	{ mlp_out_local25_address0 sc_out sc_lv 10 signal 4 } 
	{ mlp_out_local25_ce0 sc_out sc_logic 1 signal 4 } 
	{ mlp_out_local25_we0 sc_out sc_logic 1 signal 4 } 
	{ mlp_out_local25_d0 sc_out sc_lv 31 signal 4 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_54_1_1_U162", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	mlp_in_local10 { ap_memory {  { mlp_in_local10_address0 mem_address 1 9 }  { mlp_in_local10_ce0 mem_ce 1 1 }  { mlp_in_local10_q0 mem_dout 0 32 } } }
	mlp_out_local25 { ap_memory {  { mlp_out_local25_address0 mem_address 1 10 }  { mlp_out_local25_ce0 mem_ce 1 1 }  { mlp_out_local25_we0 mem_we 1 1 }  { mlp_out_local25_d0 mem_din 1 31 } } }
