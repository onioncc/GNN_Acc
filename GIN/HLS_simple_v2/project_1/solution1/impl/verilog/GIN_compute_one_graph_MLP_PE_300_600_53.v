...
module GIN_compute_one_graph_MLP_PE_300_600_53 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [9:0] mlp_out_local26_addr_reg_254;
...
wire   [53:0] r_V_22_fu_198_p2;
wire   [53:0] lhs_22_fu_204_p3;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        mlp_out_local26_addr_reg_254 <= zext_ln85_fu_168_p1;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln86_reg_264 == 1'd0) & (mlp_weight_fifo_12_V_V_full_n == 1'b0)) | ((icmp_ln86_reg_264 == 1'd0) & (mlp_weight_fifo_11_V_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln86_reg_264 == 1'd0) & (mlp_weight_fifo_12_V_V_full_n == 1'b0)) | ((icmp_ln86_reg_264 == 1'd0) & (mlp_weight_fifo_11_V_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln86_reg_264 == 1'd0) & (mlp_weight_fifo_12_V_V_full_n == 1'b0)) | ((icmp_ln86_reg_264 == 1'd0) & (mlp_weight_fifo_11_V_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (((icmp_ln86_reg_264 == 1'd0) & (mlp_weight_fifo_12_V_V_full_n == 1'b0)) | ((icmp_ln86_reg_264 == 1'd0) & (mlp_weight_fifo_11_V_V_empty_n == 1'b0)));
end
...
assign lhs_22_fu_204_p3 = {{lhs_reg_158}, {22'd0}};

assign mlp_1_bias_V_load_loc_out_din = mlp_1_bias_V_load_loc_dout;

assign mlp_in_local11_address0 = zext_ln86_fu_185_p1;

assign mlp_out_local26_address0 = mlp_out_local26_addr_reg_254;

assign mlp_out_local26_d0 = ((tmp_fu_232_p3[0:0] == 1'b1) ? 31'd0 : trunc_ln86_fu_228_p1);

assign mlp_weight_fifo_12_V_V_din = mlp_weight_fifo_11_V_V_dout;

assign ret_V_fu_212_p2 = (r_V_22_fu_198_p2 + lhs_22_fu_204_p3);
...
endmodule //GIN_compute_one_graph_MLP_PE_300_600_53
