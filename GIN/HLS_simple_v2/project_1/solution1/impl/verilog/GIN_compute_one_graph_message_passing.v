...
wire   [0:0] exitcond1204_fu_211_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond1204_fu_211_p2 == 1'd0))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter5 == 1'b1) & (icmp_ln47_reg_450_pp1_iter4_reg == 1'd0)) | ((1'b1 == ap_CS_fsm_state2) & (exitcond1204_fu_211_p2 == 1'd0)))) begin
        message_V_we1 = 1'b1;
    end else begin
        message_V_we1 = 1'b0;
    end
...
assign empty_64_fu_205_p2 = (empty_reg_161 + 19'd1);

assign exitcond1204_fu_211_p2 = ((empty_reg_161 == 19'd300000) ? 1'b1 : 1'b0);
