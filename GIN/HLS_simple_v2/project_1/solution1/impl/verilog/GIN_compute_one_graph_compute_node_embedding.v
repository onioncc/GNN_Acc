...
reg   [8:0] dim_reg_224;
wire   [18:0] empty_85_fu_235_p2;
wire    ap_CS_fsm_state2;
wire   [35:0] add_ln256_1_fu_266_p2;
reg   [35:0] add_ln256_1_reg_477;
wire    ap_CS_fsm_state3;
wire   [35:0] add_ln256_2_fu_272_p2;
reg   [35:0] add_ln256_2_reg_482;
wire    ap_CS_fsm_state4;
wire   [3:0] select_ln256_fu_295_p3;
reg   [3:0] select_ln256_reg_490;
wire   [0:0] icmp_ln256_fu_278_p2;
wire   [31:0] select_ln256_1_fu_303_p3;
reg   [31:0] select_ln256_1_reg_496;
wire   [7:0] empty_90_fu_352_p1;
reg   [7:0] empty_90_reg_511;
wire    ap_CS_fsm_state5;
wire  signed [18:0] grp_fu_457_p2;
reg  signed [18:0] mul_ln703_reg_516;
wire    ap_CS_fsm_state7;
wire   [3:0] add_ln244_fu_356_p2;
...
reg   [0:0] icmp_ln244_reg_526;
wire   [9:0] addr_1_fu_380_p2;
reg    ap_enable_reg_pp1_iter1;
wire   [15:0] mul_ln259_fu_399_p2;
reg   [15:0] mul_ln259_reg_540;
wire    ap_CS_fsm_state10;
wire   [8:0] add_ln259_fu_405_p2;
wire    ap_CS_fsm_pp2_stage0;
reg    ap_enable_reg_pp2_iter0;
wire    ap_block_state11_pp2_stage0_iter0;
wire    ap_block_state12_pp2_stage0_iter1;
wire    ap_block_pp2_stage0_11001;
wire   [0:0] icmp_ln259_fu_411_p2;
reg   [0:0] icmp_ln259_reg_550;
reg   [18:0] node_embedding_V_addr_1_reg_554;
wire   [3:0] add_ln257_fu_452_p2;
...
wire   [0:0] exitcond728_fu_241_p2;
reg   [35:0] indvar_flatten_reg_168;
reg   [31:0] nd_reg_179;
reg   [3:0] nf_reg_190;
wire    ap_block_pp1_stage0;
wire   [63:0] p_cast_fu_247_p1;
wire   [63:0] zext_ln258_fu_347_p1;
wire   [63:0] i_cast_fu_367_p1;
wire   [63:0] zext_ln703_6_fu_430_p1;
wire    ap_block_pp2_stage0;
wire   [63:0] zext_ln262_fu_440_p1;
wire   [31:0] add_ln703_fu_445_p2;
wire   [34:0] tmp_fu_255_p3;
wire   [35:0] zext_ln256_1_fu_262_p1;
wire   [35:0] zext_ln256_fu_252_p1;
wire   [0:0] icmp_ln257_fu_289_p2;
wire   [31:0] add_ln256_fu_283_p2;
wire   [10:0] trunc_ln256_1_fu_319_p1;
wire   [13:0] trunc_ln256_fu_315_p1;
wire   [13:0] zext_ln257_fu_331_p1;
wire   [13:0] add_ln258_1_fu_335_p2;
wire   [13:0] p_shl_mid2_fu_323_p3;
wire   [13:0] add_ln258_fu_341_p2;
...
reg    ap_idle_pp2;
wire    ap_enable_pp2;
wire   [15:0] mul_ln259_fu_399_p00;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        addr_reg_212 <= 10'd0;
    end else if (((1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (icmp_ln244_reg_526 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        addr_reg_212 <= addr_1_fu_380_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp2_stage0) & (icmp_ln259_fu_411_p2 == 1'd0) & (ap_enable_reg_pp2_iter0 == 1'b1) & (1'b0 == ap_block_pp2_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond728_fu_241_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        i_reg_201 <= 4'd0;
    end else if (((1'b1 == ap_CS_fsm_pp1_stage0) & (icmp_ln244_fu_362_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp2_stage0) & (icmp_ln259_fu_411_p2 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001))) begin
        node_embedding_V_addr_1_reg_554 <= zext_ln703_6_fu_430_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln256_fu_278_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if ((icmp_ln259_fu_411_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((((icmp_ln256_fu_278_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4)) | ((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln256_fu_278_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((((ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0) & (icmp_ln259_reg_550 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001)) | ((exitcond728_fu_241_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((icmp_ln244_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((icmp_ln244_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        ...
        ap_ST_fsm_pp2_stage0 : begin
            if (~((icmp_ln259_fu_411_p2 == 1'd1) & (ap_enable_reg_pp2_iter0 == 1'b1) & (1'b0 == ap_block_pp2_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp2_stage0;
            end else if (((icmp_ln259_fu_411_p2 == 1'd1) & (ap_enable_reg_pp2_iter0 == 1'b1) & (1'b0 == ap_block_pp2_stage0_subdone))) begin
...
assign add3_fu_390_p2 = (empty_88_fu_386_p1 + empty_90_reg_511);

assign add_ln244_fu_356_p2 = (i_reg_201 + 4'd1);

assign add_ln256_1_fu_266_p2 = (zext_ln256_1_fu_262_p1 + zext_ln256_fu_252_p1);

assign add_ln256_2_fu_272_p2 = (indvar_flatten_reg_168 + 36'd1);

assign add_ln256_fu_283_p2 = (nd_reg_179 + 32'd1);

assign add_ln257_fu_452_p2 = (select_ln256_reg_490 + 4'd1);

assign add_ln258_1_fu_335_p2 = (trunc_ln256_fu_315_p1 + zext_ln257_fu_331_p1);

assign add_ln258_fu_341_p2 = (add_ln258_1_fu_335_p2 + p_shl_mid2_fu_323_p3);

assign add_ln259_fu_405_p2 = (dim_reg_224 + 9'd1);

assign add_ln262_fu_435_p2 = (mul_ln259_reg_540 + zext_ln703_fu_417_p1);
...
assign empty_85_fu_235_p2 = (empty_reg_157 + 19'd1);

assign empty_88_fu_386_p1 = addr_reg_212[7:0];

assign empty_90_fu_352_p1 = node_feature_q0[7:0];

assign exitcond728_fu_241_p2 = ((empty_reg_157 == 19'd300000) ? 1'b1 : 1'b0);

assign grp_fu_457_p0 = select_ln256_1_fu_303_p3[18:0];

assign grp_fu_457_p1 = 19'd300;

assign i_cast_fu_367_p1 = i_reg_201;

assign icmp_ln244_fu_362_p2 = ((i_reg_201 == select_ln256_reg_490) ? 1'b1 : 1'b0);

assign icmp_ln256_fu_278_p2 = ((indvar_flatten_reg_168 == add_ln256_1_reg_477) ? 1'b1 : 1'b0);

assign icmp_ln257_fu_289_p2 = ((nf_reg_190 == 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln259_fu_411_p2 = ((dim_reg_224 == 9'd300) ? 1'b1 : 1'b0);

assign mul_ln259_fu_399_p0 = mul_ln259_fu_399_p00;

assign mul_ln259_fu_399_p00 = add3_fu_390_p2;

assign mul_ln259_fu_399_p1 = 16'd300;
...
assign node_embedding_table_V_address0 = zext_ln262_fu_440_p1;

assign node_feature_address0 = zext_ln258_fu_347_p1;

assign p_cast_fu_247_p1 = empty_reg_157;

assign p_shl_mid2_fu_323_p3 = {{trunc_ln256_1_fu_319_p1}, {3'd0}};

assign select_ln256_1_fu_303_p3 = ((icmp_ln257_fu_289_p2[0:0] == 1'b1) ? add_ln256_fu_283_p2 : nd_reg_179);

assign select_ln256_fu_295_p3 = ((icmp_ln257_fu_289_p2[0:0] == 1'b1) ? 4'd0 : nf_reg_190);

assign tmp_fu_255_p3 = {{num_of_nodes}, {3'd0}};

assign trunc_ln256_1_fu_319_p1 = select_ln256_1_fu_303_p3[10:0];

assign trunc_ln256_fu_315_p1 = select_ln256_1_fu_303_p3[13:0];

assign zext_ln256_1_fu_262_p1 = tmp_fu_255_p3;

assign zext_ln256_fu_252_p1 = num_of_nodes;

assign zext_ln257_fu_331_p1 = select_ln256_fu_295_p3;

assign zext_ln258_fu_347_p1 = add_ln258_fu_341_p2;

assign zext_ln262_fu_440_p1 = add_ln262_fu_435_p2;
