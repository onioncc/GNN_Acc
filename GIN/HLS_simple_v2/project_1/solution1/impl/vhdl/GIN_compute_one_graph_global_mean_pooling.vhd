...
attribute shreg_extract : string;
    ...
    signal add_ln337_fu_131_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln337_reg_200 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal icmp_ln337_fu_137_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln337_fu_143_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln337_reg_209 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln337_1_fu_147_p1 : STD_LOGIC_VECTOR (18 downto 0);
    signal zext_ln337_1_reg_214 : STD_LOGIC_VECTOR (18 downto 0);
    signal add_ln339_fu_151_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal icmp_ln339_fu_161_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln339_reg_224 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal empty_90_fu_157_p1 : STD_LOGIC_VECTOR (18 downto 0);
...
begin
    sdiv_32ns_32ns_32_36_seq_1_U168 : component GIN_compute_one_graph_sdiv_32ns_32ns_32_36_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 36,
        din0_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_condition_pp0_exit_iter0_state3) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
                    ap_enable_reg_pp0_iter0 <= ap_const_logic_0;
                elsif (((icmp_ln337_fu_137_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln339_fu_161_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln339_reg_224 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln337_fu_137_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    zext_ln337_1_reg_214(8 downto 0) <= zext_ln337_1_fu_147_p1(8 downto 0);
                    zext_ln337_reg_209(8 downto 0) <= zext_ln337_fu_143_p1(8 downto 0);
            end if;
        end if;
    end process;
    zext_ln337_reg_209(63 downto 9) <= "0000000000000000000000000000000000000000000000000000000";
    zext_ln337_1_reg_214(18 downto 9) <= "0000000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln337_fu_137_p2, ap_enable_reg_pp0_iter0, icmp_ln339_fu_161_p2, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln337_fu_137_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                end if;
            when ap_ST_fsm_pp0_stage0 => 
                if (not(((icmp_ln339_fu_161_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif (((icmp_ln339_fu_161_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
    ...
    add_ln337_fu_131_p2 <= std_logic_vector(unsigned(dim_reg_86) + unsigned(ap_const_lv9_1));
    add_ln339_fu_151_p2 <= std_logic_vector(unsigned(nd_reg_97) + unsigned(ap_const_lv32_1));
    add_ln703_5_fu_166_p2 <= std_logic_vector(unsigned(phi_mul_reg_120) + unsigned(ap_const_lv41_12C));
    add_ln703_fu_172_p2 <= std_logic_vector(unsigned(empty_90_fu_157_p1) + unsigned(zext_ln337_1_reg_214));
    ...
    ap_condition_pp0_exit_iter0_state3_assign_proc : process(icmp_ln339_fu_161_p2)
    begin
        if ((icmp_ln339_fu_161_p2 = ap_const_lv1_1)) then 
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln337_fu_137_p2)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((icmp_ln337_fu_137_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln337_fu_137_p2)
    begin
        if (((icmp_ln337_fu_137_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    empty_90_fu_157_p1 <= phi_mul_reg_120(19 - 1 downto 0);
    graph_embedding_V_address1 <= zext_ln337_reg_209(9 - 1 downto 0);
    ...
    icmp_ln337_fu_137_p2 <= "1" when (dim_reg_86 = ap_const_lv9_12C) else "0";
    icmp_ln339_fu_161_p2 <= "1" when (nd_reg_97 = num_of_nodes) else "0";
    ...
    zext_ln337_1_fu_147_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(dim_reg_86),19));
    zext_ln337_fu_143_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(dim_reg_86),64));
