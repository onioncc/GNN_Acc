...
void message_passing(FM_TYPE ed[MAX_EDGE][EMB_DIM], FM_TYPE h[MAX_NODE][EMB_DIM], int num_of_nodes, int num_of_edges)
{
...
#pragma HLS inline off
    ...
    ////////////// Message Passing
    message_passing(e_edge, h_node, num_of_nodes, num_of_edges);
