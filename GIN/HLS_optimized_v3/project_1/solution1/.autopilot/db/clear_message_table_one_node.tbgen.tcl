set moduleName clear_message_table_one_node
set isTopModule 0
...
set C_modelName {clear_message_table_one_node}
set C_modelType { void 0 }
set C_modelArgList {
	{ message_tb int 32 regular {array 20000 { 3 0 } 0 1 }  }
	{ message_tb_offset int 5 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "message_tb", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "message_tb_offset", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ message_tb_offset sc_in sc_lv 5 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "message_tb_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "message_tb_offset", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_5ns_8ns_12_1_1_U11", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	message_tb_offset { ap_none {  { message_tb_offset in_data 0 5 } } }
}
