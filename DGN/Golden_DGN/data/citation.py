...
class CitationDGL(torch.utils.data.Dataset):
...
class CitationDataset(Dataset):
    def __init__(self, name, pos_enc_dim=0, norm='none', verbose=True):
        ...
        self.name = name
        self.dataset = CitationFull(f'../../graphs/{name.lower()}', name)

        self.train = CitationDGL(self.dataset, norm=norm, pos_enc_dim=pos_enc_dim)
        self.val = self.train
