...
from data.planetoid import PlanetoidDataset  # import dataset
...
def train_val_pipeline(dataset, params, net_params):
    ...
    torch.save(model, f'dgn_{DATASET_NAME.lower()}.pt')
...
def main():
    ...
    dataset = PlanetoidDataset(DATASET_NAME, pos_enc_dim=int(args.pos_enc_dim), norm=args.lap_norm)
    # parameters
