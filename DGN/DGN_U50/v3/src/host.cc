...
int main(int argc, char **argv) {
    ...
    printf("Migrating nums_of_nodes_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({nums_of_nodes_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating nums_of_edges_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({nums_of_edges_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating reload_weights_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({reload_weights_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating node_feature_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({node_feature_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating node_eigen_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({node_eigen_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating edge_list_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({edge_list_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating embedding_h_atom_embedding_list_weights_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({embedding_h_atom_embedding_list_weights_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating layers_posttrans_fully_connected_0_linear_weight_in_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({layers_posttrans_fully_connected_0_linear_weight_in_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating layers_posttrans_fully_connected_0_linear_bias_in_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({layers_posttrans_fully_connected_0_linear_bias_in_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating MLP_layer_FC_layers_0_weight_in_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({MLP_layer_FC_layers_0_weight_in_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating MLP_layer_FC_layers_0_bias_in_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({MLP_layer_FC_layers_0_bias_in_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating MLP_layer_FC_layers_1_weight_in_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({MLP_layer_FC_layers_1_weight_in_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating MLP_layer_FC_layers_1_bias_in_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({MLP_layer_FC_layers_1_bias_in_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating MLP_layer_FC_layers_2_weight_in_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({MLP_layer_FC_layers_2_weight_in_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating MLP_layer_FC_layers_2_bias_in_buf to device ...\n");
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({MLP_layer_FC_layers_2_bias_in_buf}, 0));
    OCL_CHECK(err, err = q.finish());
    printf("Computing DGN ...\n");
    OCL_CHECK(err, err = q.enqueueTask(krnl_DGN_compute_graphs));
    OCL_CHECK(err, err = q.finish());
    printf("Migrating result_buf to host ...\n");
