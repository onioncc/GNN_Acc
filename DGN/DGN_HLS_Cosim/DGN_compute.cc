...
#pragma HLS INTERFACE m_axi depth=(500) port=out offset=slave bundle=mem
#pragma HLS INTERFACE m_axi depth=(1433 * 500) port=node_feature_in offset=slave bundle=node_feature
#pragma HLS INTERFACE m_axi depth=(4 * 500) port=node_eigen_in offset=slave bundle=node_eigen
#pragma HLS INTERFACE m_axi depth=(500 * 2) port=degree_table offset=slave bundle=degree_table
#pragma HLS INTERFACE m_axi depth=(500) port=neighbor_table offset=slave bundle=neighbor_table
#pragma HLS INTERFACE m_axi depth=(3) port=graph_attr offset=slave bundle=mem
#pragma HLS INTERFACE m_axi depth=(100 * 1433) port=embedding_FC_weight_in offset=slave bundle=mem
