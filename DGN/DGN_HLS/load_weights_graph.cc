...
void load_weights()
{
    ...
    for (int i = 0; i < 11900; i++) embedding_h_atom_embedding_list_0_weight[i / 100][i % 100] = WT_TYPE(embedding_h_atom_embedding_list_0_weight_float[i]);
    ...
    for (int i = 0; i < 400; i++) embedding_h_atom_embedding_list_1_weight[i / 100][i % 100] = WT_TYPE(embedding_h_atom_embedding_list_1_weight_float[i]);
    ...
    for (int i = 0; i < 1200; i++) embedding_h_atom_embedding_list_2_weight[i / 100][i % 100] = WT_TYPE(embedding_h_atom_embedding_list_2_weight_float[i]);
    ...
    for (int i = 0; i < 1200; i++) embedding_h_atom_embedding_list_3_weight[i / 100][i % 100] = WT_TYPE(embedding_h_atom_embedding_list_3_weight_float[i]);
    ...
    for (int i = 0; i < 1000; i++) embedding_h_atom_embedding_list_4_weight[i / 100][i % 100] = WT_TYPE(embedding_h_atom_embedding_list_4_weight_float[i]);
    ...
    for (int i = 0; i < 600; i++) embedding_h_atom_embedding_list_5_weight[i / 100][i % 100] = WT_TYPE(embedding_h_atom_embedding_list_5_weight_float[i]);
    ...
    for (int i = 0; i < 600; i++) embedding_h_atom_embedding_list_6_weight[i / 100][i % 100] = WT_TYPE(embedding_h_atom_embedding_list_6_weight_float[i]);
    ...
    for (int i = 0; i < 200; i++) embedding_h_atom_embedding_list_7_weight[i / 100][i % 100] = WT_TYPE(embedding_h_atom_embedding_list_7_weight_float[i]);
    ...
    for (int i = 0; i < 200; i++) embedding_h_atom_embedding_list_8_weight[i / 100][i % 100] = WT_TYPE(embedding_h_atom_embedding_list_8_weight_float[i]);
    ...
    for (int i = 0; i < 20000; i++) layers_0_posttrans_fully_connected_0_linear_weight[i / 200][i % 200] = WT_TYPE(layers_0_posttrans_fully_connected_0_linear_weight_float[i]);
    ...
    for (int i = 0; i < 100; i++) layers_0_posttrans_fully_connected_0_linear_bias[i] = WT_TYPE(layers_0_posttrans_fully_connected_0_linear_bias_float[i]);
    ...
    for (int i = 0; i < 20000; i++) layers_1_posttrans_fully_connected_0_linear_weight[i / 200][i % 200] = WT_TYPE(layers_1_posttrans_fully_connected_0_linear_weight_float[i]);
    ...
    for (int i = 0; i < 100; i++) layers_1_posttrans_fully_connected_0_linear_bias[i] = WT_TYPE(layers_1_posttrans_fully_connected_0_linear_bias_float[i]);
    ...
    for (int i = 0; i < 20000; i++) layers_2_posttrans_fully_connected_0_linear_weight[i / 200][i % 200] = WT_TYPE(layers_2_posttrans_fully_connected_0_linear_weight_float[i]);
    ...
    for (int i = 0; i < 100; i++) layers_2_posttrans_fully_connected_0_linear_bias[i] = WT_TYPE(layers_2_posttrans_fully_connected_0_linear_bias_float[i]);
    ...
    for (int i = 0; i < 20000; i++) layers_3_posttrans_fully_connected_0_linear_weight[i / 200][i % 200] = WT_TYPE(layers_3_posttrans_fully_connected_0_linear_weight_float[i]);
    ...
    for (int i = 0; i < 100; i++) layers_3_posttrans_fully_connected_0_linear_bias[i] = WT_TYPE(layers_3_posttrans_fully_connected_0_linear_bias_float[i]);
