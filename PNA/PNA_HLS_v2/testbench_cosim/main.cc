...
int main()
{
    ...
    PNA_compute_graphs(
        ...
        &node_conv_weights_fixed,
        &node_conv_bias_fixed,
        &graph_mlp_1_weights_fixed,
        &graph_mlp_1_bias_fixed,
        &graph_mlp_2_weights_fixed,
        &graph_mlp_2_bias_fixed,
        &graph_mlp_3_weights_fixed,
        &graph_mlp_3_bias_fixed,
        &avg_deg_fixed
    );
