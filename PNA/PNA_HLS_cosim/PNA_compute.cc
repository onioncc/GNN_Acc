...
#pragma HLS INTERFACE m_axi depth = (119*80) port = node_emb_atom_embedding_list_0_weight_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (4*80) port = node_emb_atom_embedding_list_1_weight_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (12*80) port = node_emb_atom_embedding_list_2_weight_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (12*80) port = node_emb_atom_embedding_list_3_weight_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (10*80) port = node_emb_atom_embedding_list_4_weight_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (6*80) port = node_emb_atom_embedding_list_5_weight_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (6*80) port = node_emb_atom_embedding_list_6_weight_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (2*80) port = node_emb_atom_embedding_list_7_weight_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (2*80) port = node_emb_atom_embedding_list_8_weight_fixed_in offset = slave bundle = mem

#pragma HLS INTERFACE m_axi depth = (40*80) port = mlp_0_weight_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (40) port = mlp_0_bias_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (20*40) port = mlp_2_weight_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (20) port = mlp_2_bias_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (1*20) port = mlp_4_weight_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (1) port = mlp_4_bias_fixed_in offset = slave bundle = mem

#pragma HLS INTERFACE m_axi depth = (4*80*960) port = convs_ALL_post_nn_0_weight_fixed_in offset = slave bundle = mem
#pragma HLS INTERFACE m_axi depth = (4*80) port = convs_ALL_post_nn_0_bias_fixed_in offset = slave bundle = mem
