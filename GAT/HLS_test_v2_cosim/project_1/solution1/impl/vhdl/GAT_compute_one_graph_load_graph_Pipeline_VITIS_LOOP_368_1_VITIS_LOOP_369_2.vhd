...
entity GAT_compute_one_graph_load_graph_Pipeline_VITIS_LOOP_368_1_VITIS_LOOP_369_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    sext_ln368 : IN STD_LOGIC_VECTOR (61 downto 0);
...
architecture behav of GAT_compute_one_graph_load_graph_Pipeline_VITIS_LOOP_368_1_VITIS_LOOP_369_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln368_reg_432 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state2_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state3_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal icmp_ln368_fu_300_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln368_fu_361_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal select_ln368_fu_345_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal dim_in_fu_102 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln369_fu_390_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal nd_fu_106 : STD_LOGIC_VECTOR (4 downto 0);
    signal select_ln368_1_fu_353_p3 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal add_ln368_1_fu_306_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal shl_ln_fu_374_p3 : STD_LOGIC_VECTOR (27 downto 0);
    signal icmp_ln369_fu_339_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln368_fu_333_p2 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ...
                    dim_in_fu_102 <= add_ln369_fu_390_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln368_fu_300_p2 = ap_const_lv1_0))) then 
                    indvar_flatten_fu_110 <= add_ln368_1_fu_306_p2;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ...
                    nd_fu_106 <= select_ln368_1_fu_353_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln368_reg_432 <= icmp_ln368_fu_300_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln368_reg_432 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln368_1_fu_306_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten_load) + unsigned(ap_const_lv8_1));
    add_ln368_fu_333_p2 <= std_logic_vector(unsigned(nd_fu_106) + unsigned(ap_const_lv5_1));
    add_ln369_fu_390_p2 <= std_logic_vector(unsigned(select_ln368_fu_345_p3) + unsigned(ap_const_lv4_1));
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(0);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, m_axi_mem_RVALID, icmp_ln368_reg_432)
    begin
                ap_block_pp0_stage0_11001 <= ((icmp_ln368_reg_432 = ap_const_lv1_0) and (m_axi_mem_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, m_axi_mem_RVALID, icmp_ln368_reg_432)
    begin
                ap_block_pp0_stage0_subdone <= ((icmp_ln368_reg_432 = ap_const_lv1_0) and (m_axi_mem_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;

        ap_block_state1_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_mem_RVALID, icmp_ln368_reg_432)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((icmp_ln368_reg_432 = ap_const_lv1_0) and (m_axi_mem_RVALID = ap_const_logic_0));
    end process;

        ap_block_state3_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln368_fu_300_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln368_fu_300_p2 = ap_const_lv1_1))) then 
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln368_reg_432, ap_block_pp0_stage0_subdone)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (icmp_ln368_reg_432 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln368_fu_300_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten_load = ap_const_lv8_AB) else "0";
    icmp_ln369_fu_339_p2 <= "1" when (dim_in_fu_102 = ap_const_lv4_9) else "0";
    ...
    m_axi_mem_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln368_reg_432, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln368_reg_432 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    mem_blk_n_R_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, m_axi_mem_RVALID, icmp_ln368_reg_432, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln368_reg_432 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    out_nodes_features_skip_concat_bias_V_0_address1 <= zext_ln368_fu_361_p1(7 - 1 downto 0);
    ...
    out_nodes_features_skip_concat_bias_V_0_we1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, select_ln368_fu_345_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (select_ln368_fu_345_p3 = ap_const_lv4_0))) then 
    ...
    out_nodes_features_skip_concat_bias_V_1_address1 <= zext_ln368_fu_361_p1(7 - 1 downto 0);
    ...
    out_nodes_features_skip_concat_bias_V_1_we1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, select_ln368_fu_345_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (select_ln368_fu_345_p3 = ap_const_lv4_1))) then 
    ...
    out_nodes_features_skip_concat_bias_V_2_address1 <= zext_ln368_fu_361_p1(7 - 1 downto 0);
    ...
    out_nodes_features_skip_concat_bias_V_2_we1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, select_ln368_fu_345_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (select_ln368_fu_345_p3 = ap_const_lv4_2))) then 
    ...
    out_nodes_features_skip_concat_bias_V_3_address1 <= zext_ln368_fu_361_p1(7 - 1 downto 0);
    ...
    out_nodes_features_skip_concat_bias_V_3_we1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, select_ln368_fu_345_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (select_ln368_fu_345_p3 = ap_const_lv4_3))) then 
    ...
    out_nodes_features_skip_concat_bias_V_4_address1 <= zext_ln368_fu_361_p1(7 - 1 downto 0);
    ...
    out_nodes_features_skip_concat_bias_V_4_we1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, select_ln368_fu_345_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (select_ln368_fu_345_p3 = ap_const_lv4_4))) then 
    ...
    out_nodes_features_skip_concat_bias_V_5_address1 <= zext_ln368_fu_361_p1(7 - 1 downto 0);
    ...
    out_nodes_features_skip_concat_bias_V_5_we1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, select_ln368_fu_345_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (select_ln368_fu_345_p3 = ap_const_lv4_5))) then 
    ...
    out_nodes_features_skip_concat_bias_V_6_address1 <= zext_ln368_fu_361_p1(7 - 1 downto 0);
    ...
    out_nodes_features_skip_concat_bias_V_6_we1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, select_ln368_fu_345_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (select_ln368_fu_345_p3 = ap_const_lv4_6))) then 
    ...
    out_nodes_features_skip_concat_bias_V_7_address1 <= zext_ln368_fu_361_p1(7 - 1 downto 0);
    ...
    out_nodes_features_skip_concat_bias_V_7_we1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, select_ln368_fu_345_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (select_ln368_fu_345_p3 = ap_const_lv4_7))) then 
    ...
    out_nodes_features_skip_concat_bias_V_8_address1 <= zext_ln368_fu_361_p1(7 - 1 downto 0);
    ...
    out_nodes_features_skip_concat_bias_V_8_we1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, select_ln368_fu_345_p3)
    begin
        if ((not((select_ln368_fu_345_p3 = ap_const_lv4_0)) and not((select_ln368_fu_345_p3 = ap_const_lv4_1)) and not((select_ln368_fu_345_p3 = ap_const_lv4_2)) and not((select_ln368_fu_345_p3 = ap_const_lv4_3)) and not((select_ln368_fu_345_p3 = ap_const_lv4_4)) and not((select_ln368_fu_345_p3 = ap_const_lv4_5)) and not((select_ln368_fu_345_p3 = ap_const_lv4_6)) and not((select_ln368_fu_345_p3 = ap_const_lv4_7)) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    select_ln368_1_fu_353_p3 <= 
        add_ln368_fu_333_p2 when (icmp_ln369_fu_339_p2(0) = '1') else 
        nd_fu_106;
    select_ln368_fu_345_p3 <= 
        ap_const_lv4_0 when (icmp_ln369_fu_339_p2(0) = '1') else 
        dim_in_fu_102;
    shl_ln_fu_374_p3 <= (trunc_ln740_reg_436 & ap_const_lv18_0);
    trunc_ln740_fu_323_p1 <= m_axi_mem_RDATA(10 - 1 downto 0);
    zext_ln368_fu_361_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln368_1_fu_353_p3),64));
end behav;
