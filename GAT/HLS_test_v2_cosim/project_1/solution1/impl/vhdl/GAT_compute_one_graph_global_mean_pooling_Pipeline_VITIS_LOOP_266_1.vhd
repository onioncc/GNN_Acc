...
entity GAT_compute_one_graph_global_mean_pooling_Pipeline_VITIS_LOOP_266_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of GAT_compute_one_graph_global_mean_pooling_Pipeline_VITIS_LOOP_266_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln266_fu_2523_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln266_fu_2529_p2 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    mux_164_28_1_1_U3428 : component GAT_compute_one_graph_mux_164_28_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 28,
    ...
    mux_646_28_1_1_U3441 : component GAT_compute_one_graph_mux_646_28_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 28,
    ...
    mux_646_28_1_1_U3442 : component GAT_compute_one_graph_mux_646_28_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 28,
    ...
    mux_646_28_1_1_U3443 : component GAT_compute_one_graph_mux_646_28_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 28,
    ...
    mul_46s_48ns_93_3_1_U3447 : component GAT_compute_one_graph_mul_46s_48ns_93_3_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 46,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln266_fu_2523_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln266_fu_2523_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln266_fu_2529_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_dim_1) + unsigned(ap_const_lv5_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln266_fu_2523_p2)
    begin
        if (((icmp_ln266_fu_2523_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln266_fu_2523_p2 <= "1" when (ap_sig_allocacmp_dim_1 = ap_const_lv5_10) else "0";
