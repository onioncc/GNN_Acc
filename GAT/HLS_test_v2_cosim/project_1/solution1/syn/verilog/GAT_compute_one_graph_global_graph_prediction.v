...
wire   [0:0] icmp_ln305_fu_180_p2;
reg  signed [27:0] r_V_reg_281;
reg  signed [27:0] pred_linear_weight_V_load_reg_286;
wire   [45:0] r_V_1_fu_209_p2;
reg   [45:0] r_V_1_reg_291;
...
wire  signed [63:0] sext_ln304_fu_157_p1;
reg   [27:0] lhs_fu_84;
reg   [4:0] dim_fu_88;
wire   [4:0] add_ln305_fu_186_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        dim_fu_88 <= 5'd0;
    end else if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln305_fu_180_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((icmp_ln305_fu_180_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b0)) | ((m_axi_mem_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state12)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((m_axi_mem_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state12))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((m_axi_mem_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (*) begin
    if (((m_axi_mem_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state7))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln305_fu_180_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone)) & ~((ap_enable_reg_pp0_iter3 == 1'b1) & (ap_enable_reg_pp0_iter2 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter3 == 1'b1) & (ap_enable_reg_pp0_iter2 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln305_fu_180_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
...
assign add_ln305_fu_186_p2 = (dim_fu_88 + 5'd1);
...
assign icmp_ln305_fu_180_p2 = ((dim_fu_88 == 5'd16) ? 1'b1 : 1'b0);
...
assign ret_V_fu_223_p2 = (lhs_1_fu_215_p3 + r_V_1_reg_291);

assign sext_ln304_fu_157_p1 = $signed(trunc_ln_fu_147_p4);
