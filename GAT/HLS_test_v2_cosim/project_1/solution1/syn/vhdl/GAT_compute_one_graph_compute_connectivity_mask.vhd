...
port (
    ...
    connectivity_mask_final_address1 : OUT STD_LOGIC_VECTOR (15 downto 0);
    ...
    grp_fu_2672_p_din0 : OUT STD_LOGIC_VECTOR (30 downto 0);
    grp_fu_2672_p_din1 : OUT STD_LOGIC_VECTOR (30 downto 0);
    grp_fu_2672_p_dout0 : IN STD_LOGIC_VECTOR (61 downto 0);
...
attribute shreg_extract : string;
    ...
    signal connectivity_mask_address0 : STD_LOGIC_VECTOR (15 downto 0);
    signal connectivity_mask_ce0 : STD_LOGIC;
    signal connectivity_mask_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal connectivity_mask_address1 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal mul_ln413_reg_111 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal icmp_ln413_fu_81_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln413_reg_122 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln428_fu_86_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln428_reg_126 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal trunc_ln428_fu_91_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal trunc_ln428_reg_130 : STD_LOGIC_VECTOR (30 downto 0);
    signal zext_ln432_fu_94_p1 : STD_LOGIC_VECTOR (61 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal mul_ln432_reg_143 : STD_LOGIC_VECTOR (61 downto 0);
    ...
    signal grp_compute_connectivity_mask_Pipeline_1_fu_42_connectivity_mask_address1 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_connectivity_mask_address0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_connectivity_mask_ce0 : STD_LOGIC;
    signal grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_connectivity_mask_address1 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_address0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_ce0 : STD_LOGIC;
    signal grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_address1 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_432_3_VITIS_LOOP_433_4_fu_65_connectivity_mask_final_address1 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_432_3_VITIS_LOOP_433_4_fu_65_connectivity_mask_address0 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal icmp_ln428_fu_86_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln428_fu_91_p0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    port (
        ...
        connectivity_mask_address1 : OUT STD_LOGIC_VECTOR (15 downto 0);
    ...
    port (
        ...
        edge_list_ce1 : OUT STD_LOGIC;
        edge_list_q1 : IN STD_LOGIC_VECTOR (31 downto 0);
        connectivity_mask_address0 : OUT STD_LOGIC_VECTOR (15 downto 0);
    ...
    component GAT_compute_one_graph_mul_32s_32s_32_2_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component GAT_compute_one_graph_mul_31ns_31ns_62_2_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((icmp_ln413_fu_81_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln428_fu_86_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state6))) then
                trunc_ln428_reg_130 <= trunc_ln428_fu_91_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, icmp_ln428_fu_86_p2, ap_CS_fsm_state6, ap_CS_fsm_state8, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_ap_done, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_ap_done, ap_CS_fsm_state4, ap_CS_fsm_state10, ap_block_state10_on_subcall_done, ap_block_state4_on_subcall_done)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state6 => 
                if (((icmp_ln428_fu_86_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state6) and (grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_ap_done = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state10;
                elsif (((icmp_ln428_fu_86_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state6) and (grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_ap_done = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_state8 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state8) and (grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_ap_done = ap_const_logic_1))) then
    ...
    ap_ST_fsm_state6_blk_assign_proc : process(grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_ap_done)
    begin
    ...
    ap_ST_fsm_state8_blk_assign_proc : process(grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_ap_done)
    begin
    ...
    ap_block_state10_on_subcall_done_assign_proc : process(icmp_ln428_reg_126, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_432_3_VITIS_LOOP_433_4_fu_65_ap_done)
    begin
                ap_block_state10_on_subcall_done <= ((icmp_ln428_reg_126 = ap_const_lv1_1) and (grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_432_3_VITIS_LOOP_433_4_fu_65_ap_done = ap_const_logic_0));
    end process;


    ap_block_state4_on_subcall_done_assign_proc : process(icmp_ln413_reg_122, grp_compute_connectivity_mask_Pipeline_1_fu_42_ap_done)
    begin
                ap_block_state4_on_subcall_done <= ((icmp_ln413_reg_122 = ap_const_lv1_0) and (grp_compute_connectivity_mask_Pipeline_1_fu_42_ap_done = ap_const_logic_0));
    end process;


    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state10, ap_block_state10_on_subcall_done)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_0)) or ((ap_const_boolean_0 = ap_block_state10_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state10)))) then 
    ...
    connectivity_mask_address0_assign_proc : process(icmp_ln428_reg_126, ap_CS_fsm_state6, ap_CS_fsm_state8, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_connectivity_mask_address0, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_address0, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_432_3_VITIS_LOOP_433_4_fu_65_connectivity_mask_address0, ap_CS_fsm_state10)
    begin
        if (((icmp_ln428_reg_126 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state10))) then 
            connectivity_mask_address0 <= grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_432_3_VITIS_LOOP_433_4_fu_65_connectivity_mask_address0;
            ...
            connectivity_mask_address0 <= "XXXXXXXXXXXXXXXX";
        end if; 
    end process;


    connectivity_mask_address1_assign_proc : process(icmp_ln413_reg_122, ap_CS_fsm_state6, ap_CS_fsm_state8, grp_compute_connectivity_mask_Pipeline_1_fu_42_connectivity_mask_address1, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_connectivity_mask_address1, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_address1, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            connectivity_mask_address1 <= grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_address1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            connectivity_mask_address1 <= grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_connectivity_mask_address1;
        elsif (((icmp_ln413_reg_122 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
            connectivity_mask_address1 <= grp_compute_connectivity_mask_Pipeline_1_fu_42_connectivity_mask_address1;
        else 
            connectivity_mask_address1 <= "XXXXXXXXXXXXXXXX";
        end if; 
    end process;


    connectivity_mask_ce0_assign_proc : process(icmp_ln428_reg_126, ap_CS_fsm_state6, ap_CS_fsm_state8, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_connectivity_mask_ce0, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_ce0, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_432_3_VITIS_LOOP_433_4_fu_65_connectivity_mask_ce0, ap_CS_fsm_state10)
    begin
        if (((icmp_ln428_reg_126 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state10))) then 
            connectivity_mask_ce0 <= grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_432_3_VITIS_LOOP_433_4_fu_65_connectivity_mask_ce0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
    ...
    connectivity_mask_ce1_assign_proc : process(icmp_ln413_reg_122, ap_CS_fsm_state6, ap_CS_fsm_state8, grp_compute_connectivity_mask_Pipeline_1_fu_42_connectivity_mask_ce1, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_connectivity_mask_ce1, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_ce1, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            connectivity_mask_ce1 <= grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_ce1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    connectivity_mask_d1_assign_proc : process(icmp_ln413_reg_122, ap_CS_fsm_state6, ap_CS_fsm_state8, grp_compute_connectivity_mask_Pipeline_1_fu_42_connectivity_mask_d1, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_connectivity_mask_d1, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_d1, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            connectivity_mask_d1 <= grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_d1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    connectivity_mask_we1_assign_proc : process(icmp_ln413_reg_122, ap_CS_fsm_state6, ap_CS_fsm_state8, grp_compute_connectivity_mask_Pipeline_1_fu_42_connectivity_mask_we1, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_423_1_fu_49_connectivity_mask_we1, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_we1, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            connectivity_mask_we1 <= grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_connectivity_mask_we1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    grp_fu_2668_p_din0 <= num_of_nodes;
    grp_fu_2668_p_din1 <= num_of_nodes;
    grp_fu_2672_p_ce <= grp_fu_97_ce;
    grp_fu_2672_p_din0 <= zext_ln432_fu_94_p1(31 - 1 downto 0);
    grp_fu_2672_p_din1 <= zext_ln432_fu_94_p1(31 - 1 downto 0);

    grp_fu_97_ce_assign_proc : process(ap_CS_fsm_state7, ap_CS_fsm_state8, grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_ap_done)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state7) or ((ap_const_logic_1 = ap_CS_fsm_state8) and (grp_compute_connectivity_mask_Pipeline_VITIS_LOOP_428_2_fu_58_ap_done = ap_const_logic_1)))) then 
    ...
    icmp_ln413_fu_81_p2 <= "1" when (mul_ln413_reg_111 = ap_const_lv32_0) else "0";
    icmp_ln428_fu_86_p0 <= num_of_nodes;
    icmp_ln428_fu_86_p2 <= "1" when (signed(icmp_ln428_fu_86_p0) > signed(ap_const_lv32_0)) else "0";
    trunc_ln428_fu_91_p0 <= num_of_nodes;
    trunc_ln428_fu_91_p1 <= trunc_ln428_fu_91_p0(31 - 1 downto 0);
    zext_ln432_fu_94_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln428_reg_130),62));
end behav;
