...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { connectivity_mask_final_address1 { O 16 vector } connectivity_mask_final_ce1 { O 1 bit } connectivity_mask_final_we1 { O 1 bit } connectivity_mask_final_d1 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { connectivity_mask_address0 { O 16 vector } connectivity_mask_ce0 { O 1 bit } connectivity_mask_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln432 \
    op interface \
    ports { mul_ln432 { I 62 vector } } \
} "
}
