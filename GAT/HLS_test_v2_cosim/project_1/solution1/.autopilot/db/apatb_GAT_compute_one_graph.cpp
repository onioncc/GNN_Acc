...
extern "C" void GAT_compute_one_graph_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > mem_pc_buffer(241621);
          int i = 0;
...
((char*)__xlx_apatb_param_edge_list_in)[j*4+3] = mem_pc_buffer[i].range(31, 24).to_int64();
            ...
            for (int j = 0, e = 3; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_graph_attr)[j*4+0] = mem_pc_buffer[i].range(7, 0).to_int64();
...
((char*)__xlx_apatb_param_graph_attr)[j*4+3] = mem_pc_buffer[i].range(31, 24).to_int64();
            ...
            for (int j = 0, e = 1; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_task_tb)[j*4+0] = mem_pc_buffer[i].range(7, 0).to_int64();
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_graph_attr)[j];
  ...
  __xlx_offset_byte_param_task_tb = 200003*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_task_tb)[j];
  ...
  __xlx_offset_byte_param_graph_pred_linear_weight_fixed = 200004*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_graph_pred_linear_weight_fixed)[j];
  ...
  __xlx_offset_byte_param_graph_pred_linear_bias_fixed = 200020*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_graph_pred_linear_bias_fixed)[j];
  ...
  __xlx_offset_byte_param_gat_net_scoring_fn_target_fixed = 200021*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_gat_net_scoring_fn_target_fixed)[j];
  ...
  __xlx_offset_byte_param_gat_net_scoring_fn_source_fixed = 200341*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_gat_net_scoring_fn_source_fixed)[j];
  ...
  __xlx_offset_byte_param_gat_net_linear_proj_weight_fixed = 200661*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_gat_net_linear_proj_weight_fixed)[j];
  ...
  __xlx_offset_byte_param_gat_net_skip_proj_weight_fixed = 221141*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_gat_net_skip_proj_weight_fixed)[j];
  ...
  tcl_file.set_num(241621, &tcl_file.mem_depth);
