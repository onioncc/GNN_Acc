...
wire   [45:0] lhs_1_fu_217_p3;
wire   [45:0] r_V_1_fu_211_p2;
wire   [45:0] ret_V_fu_225_p2;
reg   [8:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        lhs_fu_84 <= {{ret_V_fu_225_p2[45:18]}};
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln305_fu_180_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln305_fu_180_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign lhs_1_fu_217_p3 = {{lhs_fu_84}, {18'd0}};
...
assign m_axi_mem_AWADDR = mem_addr_reg_265;
...
assign ret_V_fu_225_p2 = (lhs_1_fu_217_p3 + r_V_1_fu_211_p2);
