...
architecture behave of GAT_compute_one_graph_control_s_axi is
    ...
    constant ADDR_TASK_TB_DATA_0                          : INTEGER := 16#34#;
    constant ADDR_TASK_TB_DATA_1                          : INTEGER := 16#38#;
    constant ADDR_TASK_TB_CTRL                            : INTEGER := 16#3c#;
    constant ADDR_GRAPH_PRED_LINEAR_WEIGHT_FIXED_DATA_0   : INTEGER := 16#40#;
    constant ADDR_GRAPH_PRED_LINEAR_WEIGHT_FIXED_DATA_1   : INTEGER := 16#44#;
    constant ADDR_GRAPH_PRED_LINEAR_WEIGHT_FIXED_CTRL     : INTEGER := 16#48#;
    constant ADDR_GRAPH_PRED_LINEAR_BIAS_FIXED_DATA_0     : INTEGER := 16#4c#;
    constant ADDR_GRAPH_PRED_LINEAR_BIAS_FIXED_DATA_1     : INTEGER := 16#50#;
    constant ADDR_GRAPH_PRED_LINEAR_BIAS_FIXED_CTRL       : INTEGER := 16#54#;
    constant ADDR_GAT_NET_SCORING_FN_TARGET_FIXED_DATA_0  : INTEGER := 16#58#;
    constant ADDR_GAT_NET_SCORING_FN_TARGET_FIXED_DATA_1  : INTEGER := 16#5c#;
    constant ADDR_GAT_NET_SCORING_FN_TARGET_FIXED_CTRL    : INTEGER := 16#60#;
    constant ADDR_GAT_NET_SCORING_FN_SOURCE_FIXED_DATA_0  : INTEGER := 16#64#;
    constant ADDR_GAT_NET_SCORING_FN_SOURCE_FIXED_DATA_1  : INTEGER := 16#68#;
    constant ADDR_GAT_NET_SCORING_FN_SOURCE_FIXED_CTRL    : INTEGER := 16#6c#;
    constant ADDR_GAT_NET_LINEAR_PROJ_WEIGHT_FIXED_DATA_0 : INTEGER := 16#70#;
    constant ADDR_GAT_NET_LINEAR_PROJ_WEIGHT_FIXED_DATA_1 : INTEGER := 16#74#;
    constant ADDR_GAT_NET_LINEAR_PROJ_WEIGHT_FIXED_CTRL   : INTEGER := 16#78#;
    constant ADDR_GAT_NET_SKIP_PROJ_WEIGHT_FIXED_DATA_0   : INTEGER := 16#7c#;
    constant ADDR_GAT_NET_SKIP_PROJ_WEIGHT_FIXED_DATA_1   : INTEGER := 16#80#;
    constant ADDR_GAT_NET_SKIP_PROJ_WEIGHT_FIXED_CTRL     : INTEGER := 16#84#;
