...
extern "C" void GAT_compute_one_graph(int*, int, int, int, int, int, int, int, int, int, int);
extern "C" void apatb_GAT_compute_one_graph_hw(volatile void * __xlx_apatb_param_node_feature_in, volatile void * __xlx_apatb_param_edge_list_in, volatile void * __xlx_apatb_param_graph_attr, volatile void * __xlx_apatb_param_task_tb, volatile void * __xlx_apatb_param_graph_pred_linear_weight_fixed, volatile void * __xlx_apatb_param_graph_pred_linear_bias_fixed, volatile void * __xlx_apatb_param_gat_net_scoring_fn_target_fixed, volatile void * __xlx_apatb_param_gat_net_scoring_fn_source_fixed, volatile void * __xlx_apatb_param_gat_net_linear_proj_weight_fixed, volatile void * __xlx_apatb_param_gat_net_skip_proj_weight_fixed) {
  // Collect __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__tmp_vec
  vector<sc_bv<32> >__xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__tmp_vec;
  for (int j = 0, e = 100000; j != e; ++j) {
    ...
    __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__tmp_vec.push_back(_xlx_tmp_sc);
  }
  ...
  int __xlx_size_param_graph_attr = 3;
  ...
  int __xlx_size_param_task_tb = 1;
  int __xlx_offset_param_task_tb = 200003;
  int __xlx_offset_byte_param_task_tb = 200003*4;
  ...
  int __xlx_offset_param_graph_pred_linear_weight_fixed = 200004;
  int __xlx_offset_byte_param_graph_pred_linear_weight_fixed = 200004*4;
  for (int j = 0, e = 1; j != e; ++j) {
    sc_bv<32> _xlx_tmp_sc;
  ...
  int __xlx_offset_param_graph_pred_linear_bias_fixed = 200020;
  int __xlx_offset_byte_param_graph_pred_linear_bias_fixed = 200020*4;
  ...
  int __xlx_offset_param_gat_net_scoring_fn_target_fixed = 200021;
  int __xlx_offset_byte_param_gat_net_scoring_fn_target_fixed = 200021*4;
  for (int j = 0, e = 320; j != e; ++j) {
    sc_bv<32> _xlx_tmp_sc;
  ...
  int __xlx_offset_param_gat_net_scoring_fn_source_fixed = 200341;
  int __xlx_offset_byte_param_gat_net_scoring_fn_source_fixed = 200341*4;
  ...
  int __xlx_offset_param_gat_net_linear_proj_weight_fixed = 200661;
  int __xlx_offset_byte_param_gat_net_linear_proj_weight_fixed = 200661*4;
  for (int j = 0, e = 20480; j != e; ++j) {
    sc_bv<32> _xlx_tmp_sc;
  ...
  int __xlx_offset_param_gat_net_skip_proj_weight_fixed = 221141;
  int __xlx_offset_byte_param_gat_net_skip_proj_weight_fixed = 221141*4;
  int* __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__input_buffer= new int[__xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__tmp_vec.size()];
  for (int i = 0; i < __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__tmp_vec.size(); ++i) {
    __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__input_buffer[i] = __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__tmp_vec[i].range(31, 0).to_uint64();
  }
  // DUT call
  GAT_compute_one_graph(__xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__input_buffer, __xlx_offset_byte_param_node_feature_in, __xlx_offset_byte_param_edge_list_in, __xlx_offset_byte_param_graph_attr, __xlx_offset_byte_param_task_tb, __xlx_offset_byte_param_graph_pred_linear_weight_fixed, __xlx_offset_byte_param_graph_pred_linear_bias_fixed, __xlx_offset_byte_param_gat_net_scoring_fn_target_fixed, __xlx_offset_byte_param_gat_net_scoring_fn_source_fixed, __xlx_offset_byte_param_gat_net_linear_proj_weight_fixed, __xlx_offset_byte_param_gat_net_skip_proj_weight_fixed);
// print __xlx_apatb_param_node_feature_in
  ...
  for (int i = 0; i < __xlx_size_param_node_feature_in; ++i) {
    __xlx_node_feature_in_output_buffer[i] = __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__input_buffer[i+__xlx_offset_param_node_feature_in];
  }
  for (int i = 0; i < __xlx_size_param_node_feature_in; ++i) {
...
// print __xlx_apatb_param_edge_list_in
  ...
  for (int i = 0; i < __xlx_size_param_edge_list_in; ++i) {
    __xlx_edge_list_in_output_buffer[i] = __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__input_buffer[i+__xlx_offset_param_edge_list_in];
  }
  for (int i = 0; i < __xlx_size_param_edge_list_in; ++i) {
...
// print __xlx_apatb_param_graph_attr
  ...
  for (int i = 0; i < __xlx_size_param_graph_attr; ++i) {
    __xlx_graph_attr_output_buffer[i] = __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__input_buffer[i+__xlx_offset_param_graph_attr];
  }
  for (int i = 0; i < __xlx_size_param_graph_attr; ++i) {
...
// print __xlx_apatb_param_task_tb
  ...
  for (int i = 0; i < __xlx_size_param_task_tb; ++i) {
    __xlx_task_tb_output_buffer[i] = __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__input_buffer[i+__xlx_offset_param_task_tb];
  }
  for (int i = 0; i < __xlx_size_param_task_tb; ++i) {
...
// print __xlx_apatb_param_graph_pred_linear_weight_fixed
  ...
  for (int i = 0; i < __xlx_size_param_graph_pred_linear_weight_fixed; ++i) {
    __xlx_graph_pred_linear_weight_fixed_output_buffer[i] = __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__input_buffer[i+__xlx_offset_param_graph_pred_linear_weight_fixed];
  }
  for (int i = 0; i < __xlx_size_param_graph_pred_linear_weight_fixed; ++i) {
...
// print __xlx_apatb_param_graph_pred_linear_bias_fixed
  ...
  for (int i = 0; i < __xlx_size_param_graph_pred_linear_bias_fixed; ++i) {
    __xlx_graph_pred_linear_bias_fixed_output_buffer[i] = __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__input_buffer[i+__xlx_offset_param_graph_pred_linear_bias_fixed];
  }
  for (int i = 0; i < __xlx_size_param_graph_pred_linear_bias_fixed; ++i) {
...
// print __xlx_apatb_param_gat_net_scoring_fn_target_fixed
  ...
  for (int i = 0; i < __xlx_size_param_gat_net_scoring_fn_target_fixed; ++i) {
    __xlx_gat_net_scoring_fn_target_fixed_output_buffer[i] = __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__input_buffer[i+__xlx_offset_param_gat_net_scoring_fn_target_fixed];
  }
  for (int i = 0; i < __xlx_size_param_gat_net_scoring_fn_target_fixed; ++i) {
...
// print __xlx_apatb_param_gat_net_scoring_fn_source_fixed
  ...
  for (int i = 0; i < __xlx_size_param_gat_net_scoring_fn_source_fixed; ++i) {
    __xlx_gat_net_scoring_fn_source_fixed_output_buffer[i] = __xlx_node_feature_in_edge_list_in_graph_attr_task_tb_graph_pred_linear_weight_fixed_graph_pred_linear_bias_fixed_gat_net_scoring_fn_target_fixed_gat_net_scoring_fn_source_fixed_gat_net_linear_proj_weight_fixed_gat_net_skip_proj_weight_fixed__input_buffer[i+__xlx_offset_param_gat_net_scoring_fn_source_fixed];
  }
  for (int i = 0; i < __xlx_size_param_gat_net_scoring_fn_source_fixed; ++i) {
