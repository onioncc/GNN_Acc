...
set name GAT_compute_one_graph_mul_3ns_8ns_10_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}
...
set id 1896
set name GAT_compute_one_graph_ama_addmuladd_10ns_5ns_7ns_5ns_16_4_1
...
set ce_signed 0
set out_width 16
set arg_lists {i0 {10 0 +} i1 {5 0 +} s {10 0 +} i2 {7 0 +} m {16 1 +} i3 {5 0 +} p {16 0 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { scores_target_V_address0 { O 9 vector } scores_target_V_ce0 { O 1 bit } scores_target_V_q0 { I 28 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { all_scores_V_address1 { O 16 vector } all_scores_V_ce1 { O 1 bit } all_scores_V_we1 { O 1 bit } all_scores_V_d1 { O 28 vector } } \
} "
} else {
