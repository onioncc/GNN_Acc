...
localparam
    ...
    ADDR_TASK_TB_DATA_0                          = 8'h34,
    ADDR_TASK_TB_DATA_1                          = 8'h38,
    ADDR_TASK_TB_CTRL                            = 8'h3c,
    ADDR_GRAPH_PRED_LINEAR_WEIGHT_FIXED_DATA_0   = 8'h40,
    ADDR_GRAPH_PRED_LINEAR_WEIGHT_FIXED_DATA_1   = 8'h44,
    ADDR_GRAPH_PRED_LINEAR_WEIGHT_FIXED_CTRL     = 8'h48,
    ADDR_GRAPH_PRED_LINEAR_BIAS_FIXED_DATA_0     = 8'h4c,
    ADDR_GRAPH_PRED_LINEAR_BIAS_FIXED_DATA_1     = 8'h50,
    ADDR_GRAPH_PRED_LINEAR_BIAS_FIXED_CTRL       = 8'h54,
    ADDR_GAT_NET_SCORING_FN_TARGET_FIXED_DATA_0  = 8'h58,
    ADDR_GAT_NET_SCORING_FN_TARGET_FIXED_DATA_1  = 8'h5c,
    ADDR_GAT_NET_SCORING_FN_TARGET_FIXED_CTRL    = 8'h60,
    ADDR_GAT_NET_SCORING_FN_SOURCE_FIXED_DATA_0  = 8'h64,
    ADDR_GAT_NET_SCORING_FN_SOURCE_FIXED_DATA_1  = 8'h68,
    ADDR_GAT_NET_SCORING_FN_SOURCE_FIXED_CTRL    = 8'h6c,
    ADDR_GAT_NET_LINEAR_PROJ_WEIGHT_FIXED_DATA_0 = 8'h70,
    ADDR_GAT_NET_LINEAR_PROJ_WEIGHT_FIXED_DATA_1 = 8'h74,
    ADDR_GAT_NET_LINEAR_PROJ_WEIGHT_FIXED_CTRL   = 8'h78,
    ADDR_GAT_NET_SKIP_PROJ_WEIGHT_FIXED_DATA_0   = 8'h7c,
    ADDR_GAT_NET_SKIP_PROJ_WEIGHT_FIXED_DATA_1   = 8'h80,
    ADDR_GAT_NET_SKIP_PROJ_WEIGHT_FIXED_CTRL     = 8'h84,
    WRIDLE                                       = 2'd0,
    WRDATA                                       = 2'd1,
    WRRESP                                       = 2'd2,
    WRRESET                                      = 2'd3,
