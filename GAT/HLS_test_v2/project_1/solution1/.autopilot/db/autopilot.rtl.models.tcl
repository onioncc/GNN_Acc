set SynModuleInfo {
  ...
  {SRCNAME compute_out_nodes_features MODELNAME compute_out_nodes_features RTLNAME GAT_compute_one_graph_compute_out_nodes_features
    SUBMODULES {
      {MODELNAME GAT_compute_one_graph_mul_mul_10ns_7ns_16_4_1 RTLNAME GAT_compute_one_graph_mul_mul_10ns_7ns_16_4_1 BINDTYPE op TYPE mul IMPL dsp LATENCY 3 ALLOW_PRAGMA 1}
