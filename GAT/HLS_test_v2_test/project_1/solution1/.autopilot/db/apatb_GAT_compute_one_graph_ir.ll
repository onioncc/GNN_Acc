; ModuleID = 'C:/Users/david/Desktop/GNN_Acc/GAT/HLS_test_v2_test/project_1/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a16struct.ap_fixed.174([16 x i32]* align 512 %9, [16 x %struct.ap_fixed]* %8)
  call fastcc void @onebyonecpy_hls.p0a1struct.ap_fixed([1 x i32]* align 512 %11, [1 x %struct.ap_fixed]* %10)
  call fastcc void @onebyonecpy_hls.p0a320struct.ap_fixed.151([320 x i32]* align 512 %13, [320 x %struct.ap_fixed]* %12)
  call fastcc void @onebyonecpy_hls.p0a320struct.ap_fixed.151([320 x i32]* align 512 %15, [320 x %struct.ap_fixed]* %14)
  call fastcc void @onebyonecpy_hls.p0a20480struct.ap_fixed.137([20480 x i32]* %17, [20480 x %struct.ap_fixed]* %16)
  call fastcc void @onebyonecpy_hls.p0a20480struct.ap_fixed.137([20480 x i32]* %19, [20480 x %struct.ap_fixed]* %18)
  ret void
}
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a1struct.ap_fixed.164([1 x %struct.ap_fixed]* %6, [1 x i32]* align 512 %7)
  call fastcc void @onebyonecpy_hls.p0a16struct.ap_fixed([16 x %struct.ap_fixed]* %8, [16 x i32]* align 512 %9)
  call fastcc void @onebyonecpy_hls.p0a1struct.ap_fixed.164([1 x %struct.ap_fixed]* %10, [1 x i32]* align 512 %11)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a20480struct.ap_fixed.137([20480 x i32]* noalias, [20480 x %struct.ap_fixed]* noalias readonly) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a320struct.ap_fixed.151([320 x i32]* noalias align 512, [320 x %struct.ap_fixed]* noalias readonly) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a1struct.ap_fixed.164([1 x %struct.ap_fixed]* noalias, [1 x i32]* noalias readonly align 512) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a16struct.ap_fixed.174([16 x i32]* noalias align 512, [16 x %struct.ap_fixed]* noalias readonly) unnamed_addr #2 {
entry:
