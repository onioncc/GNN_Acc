...
set C_modelArgList {
	{ connectivity_mask int 32 regular {array 10000 { 3 0 } 0 1 } {global 1}  }
}
...
set Spec2ImplPortList { 
	connectivity_mask { ap_memory {  { connectivity_mask_address1 MemPortADDR2 1 14 }  { connectivity_mask_ce1 MemPortCE2 1 1 }  { connectivity_mask_we1 MemPortWE2 1 1 }  { connectivity_mask_d1 MemPortDIN2 1 32 } } }
}
