...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { all_attention_coefficients_V_address1 { O 16 vector } all_attention_coefficients_V_ce1 { O 1 bit } all_attention_coefficients_V_we1 { O 1 bit } all_attention_coefficients_V_d1 { O 28 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { all_scores_V_address0 { O 16 vector } all_scores_V_ce0 { O 1 bit } all_scores_V_q0 { I 28 vector } } \
} "
} else {
