...
set id 1917
set name GAT_compute_one_graph_mac_muladd_3ns_7ns_5ns_10_4_1
...
set ce_signed 0
set out_width 10
set arg_lists {i0 {3 0 +} i1 {7 0 +} m {10 1 +} i2 {5 0 +} p {10 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
set id 1919
set name GAT_compute_one_graph_mac_muladd_10ns_7ns_5ns_16_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 16
set arg_lists {i0 {10 0 +} i1 {7 0 +} m {16 1 +} i2 {5 0 +} p {16 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {add} IMPL {dsp} LATENCY 3 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { all_scores_V_address0 { O 16 vector } all_scores_V_ce0 { O 1 bit } all_scores_V_q0 { I 28 vector } all_scores_V_address1 { O 16 vector } all_scores_V_ce1 { O 1 bit } all_scores_V_we1 { O 1 bit } all_scores_V_d1 { O 28 vector } } \
} "
} else {
