...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename a_buffer_V \
    op interface \
    ports { a_buffer_V_address0 { O 4 vector } a_buffer_V_ce0 { O 1 bit } a_buffer_V_we0 { O 1 bit } a_buffer_V_d0 { O 28 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'a_buffer_V'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln185 \
    op interface \
    ports { mul_ln185 { I 10 vector } } \
} "
}
