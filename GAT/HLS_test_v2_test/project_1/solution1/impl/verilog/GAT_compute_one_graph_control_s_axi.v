...
localparam
    ...
    ADDR_IER                    = 6'h08,
    ADDR_ISR                    = 6'h0c,
    ADDR_NODE_FEATURE_IN_DATA_0 = 6'h10,
    ADDR_NODE_FEATURE_IN_DATA_1 = 6'h14,
    ADDR_NODE_FEATURE_IN_CTRL   = 6'h18,
    ADDR_EDGE_LIST_IN_DATA_0    = 6'h1c,
    ADDR_EDGE_LIST_IN_DATA_1    = 6'h20,
    ADDR_EDGE_LIST_IN_CTRL      = 6'h24,
    ADDR_GRAPH_ATTR_DATA_0      = 6'h28,
    ADDR_GRAPH_ATTR_DATA_1      = 6'h2c,
    ADDR_GRAPH_ATTR_CTRL        = 6'h30,
    ADDR_TASK_TB_DATA_0         = 6'h34,
    ADDR_TASK_TB_DATA_1         = 6'h38,
    ADDR_TASK_TB_CTRL           = 6'h3c,
    WRIDLE                      = 2'd0,
    WRDATA                      = 2'd1,
    WRRESP                      = 2'd2,
    WRRESET                     = 2'd3,
