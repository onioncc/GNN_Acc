...
module GAT_compute_one_graph_compute_out_nodes_features_Pipeline_VITIS_LOOP_149_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln149_fu_1854_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
reg   [0:0] icmp_ln149_reg_2349;
reg   [0:0] icmp_ln149_reg_2349_pp0_iter1_reg;
reg   [0:0] icmp_ln149_reg_2349_pp0_iter2_reg;
reg   [0:0] icmp_ln149_reg_2349_pp0_iter3_reg;
...
wire   [31:0] add_ln149_fu_1860_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln149_fu_1854_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln149_fu_1854_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        r_V_reg_2353 <= r_V_fu_1938_p102;
    end
end

always @ (*) begin
    if (((icmp_ln149_fu_1854_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln149_reg_2349_pp0_iter3_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
assign add_ln149_fu_1860_p2 = (ap_sig_allocacmp_n2_1 + 32'd1);
...
assign icmp_ln149_fu_1854_p2 = ((ap_sig_allocacmp_n2_1 == num_of_nodes) ? 1'b1 : 1'b0);
...
endmodule //GAT_compute_one_graph_compute_out_nodes_features_Pipeline_VITIS_LOOP_149_4
