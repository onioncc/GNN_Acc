...
module GAT_compute_one_graph_load_misc_weights_Pipeline_VITIS_LOOP_328_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln328_reg_138;
reg    ap_block_state2_pp0_stage0_iter1;
wire    ap_block_state3_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln328_fu_90_p2;
...
wire   [27:0] trunc_ln329_fu_113_p1;
reg   [27:0] trunc_ln329_reg_142;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] j_cast_fu_117_p1;
reg   [4:0] j_fu_50;
wire    ap_loop_init;
reg   [4:0] ap_sig_allocacmp_j_2;
wire   [4:0] add_ln328_fu_96_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln328_fu_90_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln328_reg_138 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        trunc_ln329_reg_142 <= trunc_ln329_fu_113_p1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln328_fu_90_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln328_reg_138 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln328_reg_138 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln328_reg_138 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln328_fu_96_p2 = (ap_sig_allocacmp_j_2 + 5'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln328_reg_138 == 1'd0) & (m_axi_mem_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln328_reg_138 == 1'd0) & (m_axi_mem_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln328_reg_138 == 1'd0) & (m_axi_mem_RVALID == 1'b0));
end
...
assign icmp_ln328_fu_90_p2 = ((ap_sig_allocacmp_j_2 == 5'd16) ? 1'b1 : 1'b0);
...
assign pred_linear_weight_V_d0 = trunc_ln329_reg_142;

assign trunc_ln329_fu_113_p1 = m_axi_mem_RDATA[27:0];

endmodule //GAT_compute_one_graph_load_misc_weights_Pipeline_VITIS_LOOP_328_2
