...
module GAT_compute_one_graph_load_weights_first_layer_Pipeline_VITIS_LOOP_277_7_VITIS_LOOP_278_8 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [27:0] trunc_ln279_fu_275_p1;
reg   [27:0] trunc_ln279_reg_372;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] zext_ln277_fu_313_p1;
reg   [3:0] j_fu_90;
wire   [3:0] add_ln278_fu_326_p2;
wire    ap_loop_init;
reg   [6:0] i_fu_94;
wire   [6:0] select_ln277_1_fu_305_p3;
reg   [9:0] indvar_flatten73_fu_98;
reg   [9:0] ap_sig_allocacmp_indvar_flatten73_load;
wire   [9:0] add_ln277_1_fu_258_p2;
wire   [3:0] select_ln277_fu_297_p3;
wire   [0:0] icmp_ln278_fu_291_p2;
wire   [6:0] add_ln277_fu_285_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln277_fu_252_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln277_reg_368 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        trunc_ln279_reg_372 <= trunc_ln279_fu_275_p1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln277_fu_252_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln277_reg_368 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln277_reg_368 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln277_reg_368 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln277_fu_297_p3 == 4'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln277_fu_297_p3 == 4'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln277_fu_297_p3 == 4'd2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln277_fu_297_p3 == 4'd3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln277_fu_297_p3 == 4'd4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln277_fu_297_p3 == 4'd5))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln277_fu_297_p3 == 4'd6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln277_fu_297_p3 == 4'd7))) begin
...
always @ (*) begin
    if ((~(select_ln277_fu_297_p3 == 4'd0) & ~(select_ln277_fu_297_p3 == 4'd1) & ~(select_ln277_fu_297_p3 == 4'd2) & ~(select_ln277_fu_297_p3 == 4'd3) & ~(select_ln277_fu_297_p3 == 4'd4) & ~(select_ln277_fu_297_p3 == 4'd5) & ~(select_ln277_fu_297_p3 == 4'd6) & ~(select_ln277_fu_297_p3 == 4'd7) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
assign add_ln277_1_fu_258_p2 = (ap_sig_allocacmp_indvar_flatten73_load + 10'd1);

assign add_ln277_fu_285_p2 = (i_fu_94 + 7'd1);

assign add_ln278_fu_326_p2 = (select_ln277_fu_297_p3 + 4'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln277_reg_368 == 1'd0) & (m_axi_mem_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln277_reg_368 == 1'd0) & (m_axi_mem_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln277_reg_368 == 1'd0) & (m_axi_mem_RVALID == 1'b0));
end
...
assign icmp_ln277_fu_252_p2 = ((ap_sig_allocacmp_indvar_flatten73_load == 10'd576) ? 1'b1 : 1'b0);

assign icmp_ln278_fu_291_p2 = ((j_fu_90 == 4'd9) ? 1'b1 : 1'b0);
...
assign select_ln277_1_fu_305_p3 = ((icmp_ln278_fu_291_p2[0:0] == 1'b1) ? add_ln277_fu_285_p2 : i_fu_94);

assign select_ln277_fu_297_p3 = ((icmp_ln278_fu_291_p2[0:0] == 1'b1) ? 4'd0 : j_fu_90);

assign skip_proj_weight_V_0_address0 = zext_ln277_fu_313_p1;

assign skip_proj_weight_V_0_d0 = trunc_ln279_reg_372;

assign skip_proj_weight_V_1_address0 = zext_ln277_fu_313_p1;

assign skip_proj_weight_V_1_d0 = trunc_ln279_reg_372;

assign skip_proj_weight_V_2_address0 = zext_ln277_fu_313_p1;

assign skip_proj_weight_V_2_d0 = trunc_ln279_reg_372;

assign skip_proj_weight_V_3_address0 = zext_ln277_fu_313_p1;

assign skip_proj_weight_V_3_d0 = trunc_ln279_reg_372;

assign skip_proj_weight_V_4_address0 = zext_ln277_fu_313_p1;

assign skip_proj_weight_V_4_d0 = trunc_ln279_reg_372;

assign skip_proj_weight_V_5_address0 = zext_ln277_fu_313_p1;

assign skip_proj_weight_V_5_d0 = trunc_ln279_reg_372;

assign skip_proj_weight_V_6_address0 = zext_ln277_fu_313_p1;

assign skip_proj_weight_V_6_d0 = trunc_ln279_reg_372;

assign skip_proj_weight_V_7_address0 = zext_ln277_fu_313_p1;

assign skip_proj_weight_V_7_d0 = trunc_ln279_reg_372;

assign skip_proj_weight_V_8_address0 = zext_ln277_fu_313_p1;

assign skip_proj_weight_V_8_d0 = trunc_ln279_reg_372;

assign trunc_ln279_fu_275_p1 = m_axi_mem_RDATA[27:0];

assign zext_ln277_fu_313_p1 = select_ln277_1_fu_305_p3;

endmodule //GAT_compute_one_graph_load_weights_first_layer_Pipeline_VITIS_LOOP_277_7_VITIS_LOOP_278_8
