...
module GAT_compute_one_graph_CONV_Pipeline_VITIS_LOOP_143_28 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln143_fu_144_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
reg   [0:0] icmp_ln143_reg_253;
reg   [0:0] icmp_ln143_reg_253_pp0_iter1_reg;
reg   [0:0] icmp_ln143_reg_253_pp0_iter2_reg;
reg   [0:0] icmp_ln143_reg_253_pp0_iter3_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln143_fu_144_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln143_fu_144_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln143_reg_253_pp0_iter3_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
assign add_ln143_fu_150_p2 = (ap_sig_allocacmp_dim_in + 31'd1);
...
assign icmp_ln143_fu_144_p2 = ((ap_sig_allocacmp_dim_in == num_in_features) ? 1'b1 : 1'b0);
...
endmodule //GAT_compute_one_graph_CONV_Pipeline_VITIS_LOOP_143_28
