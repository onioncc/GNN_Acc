...
module GAT_compute_one_graph_global_mean_pooling_Pipeline_VITIS_LOOP_235_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln235_fu_385_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
wire   [3:0] trunc_ln712_1_read_reg_455;
reg   [0:0] icmp_ln235_reg_459;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln235_fu_385_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln235_fu_385_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln235_reg_459 == 1'd1))) begin
...
assign add_ln235_fu_391_p2 = (ap_sig_allocacmp_nd_1 + 32'd1);
...
assign icmp_ln235_fu_385_p2 = ((ap_sig_allocacmp_nd_1 == num_of_nodes) ? 1'b1 : 1'b0);
...
endmodule //GAT_compute_one_graph_global_mean_pooling_Pipeline_VITIS_LOOP_235_2
