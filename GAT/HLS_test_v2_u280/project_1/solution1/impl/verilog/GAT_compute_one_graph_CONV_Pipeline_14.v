...
module GAT_compute_one_graph_CONV_Pipeline_14 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond11927_fu_64_p2;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((exitcond11927_fu_64_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (exitcond11927_fu_64_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (exitcond11927_fu_64_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign exitcond11927_fu_64_p2 = ((ap_sig_allocacmp_p_load == 13'd6400) ? 1'b1 : 1'b0);
...
endmodule //GAT_compute_one_graph_CONV_Pipeline_14
