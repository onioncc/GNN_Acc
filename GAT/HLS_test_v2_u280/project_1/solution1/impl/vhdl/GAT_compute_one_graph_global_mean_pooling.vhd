...
attribute shreg_extract : string;
    ...
    signal num_features_per_layer_load_reg_174 : STD_LOGIC_VECTOR (31 downto 0);
    signal conv_i_fu_105_p1 : STD_LOGIC_VECTOR (45 downto 0);
    signal conv_i_reg_179 : STD_LOGIC_VECTOR (45 downto 0);
    signal dim_1_reg_184 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal grp_fu_143_p2 : STD_LOGIC_VECTOR (27 downto 0);
    signal sdiv_ln1201_reg_198 : STD_LOGIC_VECTOR (27 downto 0);
    signal ap_CS_fsm_state55 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state55 : signal is "none";
    signal grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_start : STD_LOGIC;
    signal grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_done : STD_LOGIC;
    signal grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_idle : STD_LOGIC;
    signal grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_ready : STD_LOGIC;
    signal grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_sum_V_out : STD_LOGIC_VECTOR (27 downto 0);
    signal grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_sum_V_out_ap_vld : STD_LOGIC;
    signal grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_out_nodes_features_skip_concat_bias_V_address0 : STD_LOGIC_VECTOR (12 downto 0);
    signal grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_out_nodes_features_skip_concat_bias_V_ce0 : STD_LOGIC;
    signal grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal zext_ln184_fu_148_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state56 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state56 : signal is "none";
    signal dim_fu_42 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln184_fu_121_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal icmp_ln184_fu_116_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_fu_93_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal conv_i_i_i_fu_97_p3 : STD_LOGIC_VECTOR (27 downto 0);
    signal zext_ln184_1_fu_112_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_143_p0 : STD_LOGIC_VECTOR (45 downto 0);
    signal grp_fu_143_p1 : STD_LOGIC_VECTOR (27 downto 0);
    signal grp_fu_143_ap_start : STD_LOGIC;
    signal grp_fu_143_ap_done : STD_LOGIC;
    ...
    component GAT_compute_one_graph_global_mean_pooling_Pipeline_VITIS_LOOP_186_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_ready : OUT STD_LOGIC;
        num_of_nodes : IN STD_LOGIC_VECTOR (31 downto 0);
        zext_ln184 : IN STD_LOGIC_VECTOR (6 downto 0);
...
begin
    grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79 : component GAT_compute_one_graph_global_mean_pooling_Pipeline_VITIS_LOOP_186_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    sdiv_46ns_28s_28_50_seq_1_U263 : component GAT_compute_one_graph_sdiv_46ns_28s_28_50_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 50,
        din0_WIDTH => 46,
    ...
    grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
                    grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_ready = ap_const_logic_1)) then 
                    grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    dim_fu_42_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                dim_fu_42 <= ap_const_lv7_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln184_fu_116_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                    conv_i_reg_179(45 downto 18) <= conv_i_fu_105_p1(45 downto 18);
    ...
    conv_i_reg_179(17 downto 0) <= "000000000000000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state3, grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_done, ap_CS_fsm_state5, icmp_ln184_fu_116_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln184_fu_116_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
            ...
            when ap_ST_fsm_state5 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state5) and (grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_done = ap_const_logic_1))) then
    ...
    add_ln184_fu_121_p2 <= std_logic_vector(unsigned(dim_fu_42) + unsigned(ap_const_lv7_1));
    ...
    ap_ST_fsm_state5_blk_assign_proc : process(grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_done)
    begin
        if ((grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_done = ap_const_logic_0)) then 
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state3, icmp_ln184_fu_116_p2)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln184_fu_116_p2 = ap_const_lv1_1)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state3, icmp_ln184_fu_116_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln184_fu_116_p2 = ap_const_lv1_1))) then 
        ...
        conv_i_fu_105_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(conv_i_i_i_fu_97_p3),46));

    conv_i_i_i_fu_97_p3 <= (empty_fu_93_p1 & ap_const_lv18_0);
    empty_fu_93_p1 <= num_of_nodes(10 - 1 downto 0);

    grp_fu_143_ap_start_assign_proc : process(ap_CS_fsm_state6)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            grp_fu_143_ap_start <= ap_const_logic_1;
        else 
            grp_fu_143_ap_start <= ap_const_logic_0;
        end if; 
    end process;

    grp_fu_143_p0 <= (grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_sum_V_out & ap_const_lv18_0);
    grp_fu_143_p1 <= conv_i_reg_179(28 - 1 downto 0);
    grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_start <= grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_ap_start_reg;
    h_graph_V_address1 <= zext_ln184_fu_148_p1(7 - 1 downto 0);

    h_graph_V_ce1_assign_proc : process(ap_CS_fsm_state56)
    begin
    ...
    h_graph_V_d1 <= sdiv_ln1201_reg_198(28 - 1 downto 0);

    h_graph_V_we1_assign_proc : process(ap_CS_fsm_state56)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state56)) then 
    ...
    icmp_ln184_fu_116_p2 <= "1" when (zext_ln184_1_fu_112_p1 = num_features_per_layer_load_reg_174) else "0";
    num_features_per_layer_address0 <= ap_const_lv3_2;

    num_features_per_layer_ce0_assign_proc : process(ap_start, ap_CS_fsm_state1)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_nodes_features_skip_concat_bias_V_address0 <= grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_out_nodes_features_skip_concat_bias_V_address0;
    out_nodes_features_skip_concat_bias_V_ce0 <= grp_global_mean_pooling_Pipeline_VITIS_LOOP_186_2_fu_79_out_nodes_features_skip_concat_bias_V_ce0;
    zext_ln184_1_fu_112_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(dim_fu_42),32));
    zext_ln184_fu_148_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(dim_1_reg_184),64));
end behav;
