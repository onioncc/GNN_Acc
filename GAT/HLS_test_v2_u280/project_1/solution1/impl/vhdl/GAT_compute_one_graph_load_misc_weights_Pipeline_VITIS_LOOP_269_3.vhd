...
entity GAT_compute_one_graph_load_misc_weights_Pipeline_VITIS_LOOP_269_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    sext_ln269_1 : IN STD_LOGIC_VECTOR (61 downto 0);
...
architecture behav of GAT_compute_one_graph_load_misc_weights_Pipeline_VITIS_LOOP_269_3 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln269_reg_207 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_4_reg_202 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal i_4_reg_202_pp0_iter1_reg : STD_LOGIC_VECTOR (2 downto 0);
    signal i_4_reg_202_pp0_iter2_reg : STD_LOGIC_VECTOR (2 downto 0);
    signal i_4_reg_202_pp0_iter3_reg : STD_LOGIC_VECTOR (2 downto 0);
    signal i_4_reg_202_pp0_iter4_reg : STD_LOGIC_VECTOR (2 downto 0);
    signal icmp_ln269_fu_138_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln269_reg_207_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln269_reg_207_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln269_reg_207_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal mem_addr_reg_211 : STD_LOGIC_VECTOR (63 downto 0);
    signal mem_addr_5_reg_217 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal mem_addr_5_read_reg_233 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal sext_ln270_fu_160_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln271_fu_176_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_56 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_4 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln269_fu_144_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_cast_fu_150_p1 : STD_LOGIC_VECTOR (62 downto 0);
    signal sext_ln269_cast_fu_126_p1 : STD_LOGIC_VECTOR (62 downto 0);
    signal add_ln270_fu_154_p2 : STD_LOGIC_VECTOR (62 downto 0);
    signal sext_ln269_1_cast_fu_122_p1 : STD_LOGIC_VECTOR (62 downto 0);
    signal add_ln271_fu_170_p2 : STD_LOGIC_VECTOR (62 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln269_fu_138_p2 = ap_const_lv1_0))) then 
                    i_fu_56 <= add_ln269_fu_144_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                i_4_reg_202 <= ap_sig_allocacmp_i_4;
                i_4_reg_202_pp0_iter1_reg <= i_4_reg_202;
                i_4_reg_202_pp0_iter2_reg <= i_4_reg_202_pp0_iter1_reg;
                i_4_reg_202_pp0_iter3_reg <= i_4_reg_202_pp0_iter2_reg;
                i_4_reg_202_pp0_iter4_reg <= i_4_reg_202_pp0_iter3_reg;
                icmp_ln269_reg_207 <= icmp_ln269_fu_138_p2;
                icmp_ln269_reg_207_pp0_iter1_reg <= icmp_ln269_reg_207;
                icmp_ln269_reg_207_pp0_iter2_reg <= icmp_ln269_reg_207_pp0_iter1_reg;
                icmp_ln269_reg_207_pp0_iter3_reg <= icmp_ln269_reg_207_pp0_iter2_reg;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then
                ...
                mem_addr_5_read_reg_233 <= m_axi_mem_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln269_fu_138_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                mem_addr_5_reg_217 <= sext_ln271_fu_176_p1;
                mem_addr_reg_211 <= sext_ln270_fu_160_p1;
            end if;
        end if;
    end process;
    ...
    add_ln269_fu_144_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_4) + unsigned(ap_const_lv3_1));
    add_ln270_fu_154_p2 <= std_logic_vector(unsigned(i_cast_fu_150_p1) + unsigned(sext_ln269_cast_fu_126_p1));
    add_ln271_fu_170_p2 <= std_logic_vector(unsigned(i_cast_fu_150_p1) + unsigned(sext_ln269_1_cast_fu_122_p1));
    ...
    ap_block_state2_io_assign_proc : process(m_axi_mem_ARREADY, icmp_ln269_reg_207)
    begin
                ap_block_state2_io <= ((m_axi_mem_ARREADY = ap_const_logic_0) and (icmp_ln269_reg_207 = ap_const_lv1_0));
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, icmp_ln269_reg_207, ap_block_pp0_stage1_subdone)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_subdone) and (icmp_ln269_reg_207 = ap_const_lv1_1))) then 
    ...
    ap_condition_exit_pp0_iter4_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter4, icmp_ln269_reg_207_pp0_iter3_reg, ap_block_pp0_stage0_subdone)
    begin
        if (((ap_enable_reg_pp0_iter4 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln269_reg_207_pp0_iter3_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_sig_allocacmp_i_4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_fu_56, ap_loop_init)
    begin
    ...
    i_cast1_fu_191_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_4_reg_202_pp0_iter4_reg),64));
    i_cast_fu_150_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_4),63));
    icmp_ln269_fu_138_p2 <= "1" when (ap_sig_allocacmp_i_4 = ap_const_lv3_6) else "0";

    m_axi_mem_ARADDR_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, icmp_ln269_reg_207, ap_block_pp0_stage0_11001, mem_addr_reg_211, mem_addr_5_reg_217, ap_block_pp0_stage1_11001)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            m_axi_mem_ARADDR <= mem_addr_5_reg_217;
        elsif (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (icmp_ln269_reg_207 = ap_const_lv1_0))) then 
    ...
    m_axi_mem_ARVALID_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, icmp_ln269_reg_207, ap_block_pp0_stage0_11001, ap_block_pp0_stage1_11001)
    begin
        if ((((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)) or ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (icmp_ln269_reg_207 = ap_const_lv1_0)))) then 
    ...
    mem_blk_n_AR_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, m_axi_mem_ARREADY, icmp_ln269_reg_207, ap_block_pp0_stage1, ap_block_pp0_stage0)
    begin
        if ((((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1) and (icmp_ln269_reg_207 = ap_const_lv1_0)))) then 
    ...
    num_features_per_layer_d0 <= mem_addr_5_read_reg_233;
    ...
    begin
        ...
        sext_ln269_1_cast_fu_122_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln269_1),63));

        sext_ln269_cast_fu_126_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln269),63));

        sext_ln270_fu_160_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln270_fu_154_p2),64));

        sext_ln271_fu_176_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln271_fu_170_p2),64));
