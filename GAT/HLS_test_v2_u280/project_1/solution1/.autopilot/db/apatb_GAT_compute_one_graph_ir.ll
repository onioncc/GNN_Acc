; ModuleID = 'C:/Users/david/Desktop/GNN_Acc/GAT/HLS_test_v2/project_1/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %malloccall3 = call i8* @malloc(i64 400000)
  %task_tb_copy = bitcast i8* %malloccall3 to [100000 x i32]*
  ...
  %malloccall4 = call i8* @malloc(i64 81920)
  %gat_net_linear_proj_weight_fixed_copy = bitcast i8* %malloccall4 to [20480 x i32]*
  %malloccall5 = call i8* @malloc(i64 81920)
  %gat_net_skip_proj_weight_fixed_copy = bitcast i8* %malloccall5 to [20480 x i32]*
  ...
  %3 = bitcast %struct.ap_fixed* %task_tb to [100000 x %struct.ap_fixed]*
  ...
  %12 = getelementptr inbounds [100000 x i32], [100000 x i32]* %graph_attr_copy, i32 0, i32 0
  %13 = getelementptr [100000 x i32], [100000 x i32]* %task_tb_copy, i32 0, i32 0
...
define internal fastcc void @copy_in([100000 x i32]* readonly, [100000 x i32]* noalias, [100000 x i32]* readonly, [100000 x i32]* noalias, [100000 x i32]* readonly, [100000 x i32]* noalias, [100000 x %struct.ap_fixed]* readonly, [100000 x i32]* noalias, [16 x %struct.ap_fixed]* readonly, [16 x i32]* noalias align 512, [1 x %struct.ap_fixed]* readonly, [1 x i32]* noalias align 512, [320 x %struct.ap_fixed]* readonly, [320 x i32]* noalias align 512, [320 x %struct.ap_fixed]* readonly, [320 x i32]* noalias align 512, [20480 x %struct.ap_fixed]* readonly, [20480 x i32]* noalias, [20480 x %struct.ap_fixed]* readonly, [20480 x i32]* noalias) unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a100000struct.ap_fixed([100000 x i32]* %7, [100000 x %struct.ap_fixed]* %6)
  call fastcc void @onebyonecpy_hls.p0a16struct.ap_fixed.166([16 x i32]* align 512 %9, [16 x %struct.ap_fixed]* %8)
  call fastcc void @onebyonecpy_hls.p0a1struct.ap_fixed([1 x i32]* align 512 %11, [1 x %struct.ap_fixed]* %10)
  call fastcc void @onebyonecpy_hls.p0a320struct.ap_fixed.145([320 x i32]* align 512 %13, [320 x %struct.ap_fixed]* %12)
  call fastcc void @onebyonecpy_hls.p0a320struct.ap_fixed.145([320 x i32]* align 512 %15, [320 x %struct.ap_fixed]* %14)
  call fastcc void @onebyonecpy_hls.p0a20480struct.ap_fixed.131([20480 x i32]* %17, [20480 x %struct.ap_fixed]* %16)
  call fastcc void @onebyonecpy_hls.p0a20480struct.ap_fixed.131([20480 x i32]* %19, [20480 x %struct.ap_fixed]* %18)
  ret void
}
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out([100000 x i32]*, [100000 x i32]* noalias readonly, [100000 x i32]*, [100000 x i32]* noalias readonly, [100000 x i32]*, [100000 x i32]* noalias readonly, [100000 x %struct.ap_fixed]*, [100000 x i32]* noalias readonly, [16 x %struct.ap_fixed]*, [16 x i32]* noalias readonly align 512, [1 x %struct.ap_fixed]*, [1 x i32]* noalias readonly align 512, [320 x %struct.ap_fixed]*, [320 x i32]* noalias readonly align 512, [320 x %struct.ap_fixed]*, [320 x i32]* noalias readonly align 512, [20480 x %struct.ap_fixed]*, [20480 x i32]* noalias readonly, [20480 x %struct.ap_fixed]*, [20480 x i32]* noalias readonly) unnamed_addr #4 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a100000struct.ap_fixed.174([100000 x %struct.ap_fixed]* %6, [100000 x i32]* %7)
  call fastcc void @onebyonecpy_hls.p0a16struct.ap_fixed([16 x %struct.ap_fixed]* %8, [16 x i32]* align 512 %9)
  call fastcc void @onebyonecpy_hls.p0a1struct.ap_fixed.158([1 x %struct.ap_fixed]* %10, [1 x i32]* align 512 %11)
...
entry:
  %malloccall = tail call i8* @malloc(i64 400000)
  %10 = bitcast i8* %malloccall to [100000 x %struct.ap_fixed]*
  ...
  %15 = bitcast i8* %malloccall1 to [20480 x %struct.ap_fixed]*
  %malloccall2 = tail call i8* @malloc(i64 81920)
  %16 = bitcast i8* %malloccall2 to [20480 x %struct.ap_fixed]*
  %17 = bitcast i32* %0 to [100000 x i32]*
  %18 = bitcast i32* %1 to [100000 x i32]*
  %19 = bitcast i32* %2 to [100000 x i32]*
  %20 = bitcast i32* %3 to [100000 x i32]*
