...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename h_graph_V \
    op interface \
    ports { h_graph_V_address0 { O 7 vector } h_graph_V_ce0 { O 1 bit } h_graph_V_q0 { I 28 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { pred_linear_weight_V_address0 { O 4 vector } pred_linear_weight_V_ce0 { O 1 bit } pred_linear_weight_V_q0 { I 28 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { pred_linear_bias_V_0 { I 28 vector } } \
} "
}
