...
entity GAT_compute_one_graph_compute_connectivity_mask_Pipeline_VITIS_LOOP_291_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of GAT_compute_one_graph_compute_connectivity_mask_Pipeline_VITIS_LOOP_291_3 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln291_reg_238 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln291_fu_118_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln291_reg_238_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln292_fu_198_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln292_reg_278 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal zext_ln292_fu_142_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln292_1_fu_161_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln292_2_fu_170_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal reuse_addr_reg_fu_40 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal reuse_reg_fu_44 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal i_3_fu_48 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_i : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln291_fu_124_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln292_fu_130_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal or_ln292_fu_156_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal zext_ln292_2_fu_170_p0 : STD_LOGIC_VECTOR (13 downto 0);
...
begin
    mac_muladd_14s_7ns_14ns_14_4_1_U71 : component GAT_compute_one_graph_mac_muladd_14s_7ns_14ns_14_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 14,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln291_fu_118_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_3_fu_48 <= add_ln291_fu_124_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_3_fu_48 <= ap_const_lv32_0;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    reuse_addr_reg_fu_40 <= zext_ln292_2_fu_170_p1;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    reuse_reg_fu_44 <= add_ln292_reg_278;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                add_ln292_reg_278 <= add_ln292_fu_198_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                connectivity_mask_addr_reg_267 <= zext_ln292_2_fu_170_p1(14 - 1 downto 0);
                icmp_ln291_reg_238 <= icmp_ln291_fu_118_p2;
                icmp_ln291_reg_238_pp0_iter1_reg <= icmp_ln291_reg_238;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln291_fu_118_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln291_fu_124_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv32_1));
    add_ln292_fu_198_p2 <= std_logic_vector(unsigned(reuse_select_fu_191_p3) + unsigned(ap_const_lv32_1));
    addr_cmp_fu_177_p2 <= "1" when (reuse_addr_reg_fu_40 = zext_ln292_2_fu_170_p1) else "0";
    ...
    ap_condition_exit_pp0_iter0_stage1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_subdone, icmp_ln291_reg_238)
    begin
        if (((icmp_ln291_reg_238 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    ap_condition_exit_pp0_iter2_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter2, icmp_ln291_reg_238_pp0_iter1_reg, ap_block_pp0_stage0_subdone)
    begin
        if (((icmp_ln291_reg_238_pp0_iter1_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, i_3_fu_48)
    begin
    ...
    connectivity_mask_address0 <= zext_ln292_2_fu_170_p1(14 - 1 downto 0);
    ...
    connectivity_mask_d1 <= add_ln292_reg_278;
    ...
    edge_list_address0 <= zext_ln292_1_fu_161_p1(10 - 1 downto 0);
    edge_list_address1 <= zext_ln292_fu_142_p1(10 - 1 downto 0);
    ...
    icmp_ln291_fu_118_p2 <= "1" when (ap_sig_allocacmp_i = num_of_edges) else "0";
    or_ln292_fu_156_p2 <= (shl_ln_reg_242 or ap_const_lv10_1);
    reuse_select_fu_191_p3 <= 
        reuse_reg_fu_44 when (addr_cmp_reg_273(0) = '1') else 
        connectivity_mask_q0;
    shl_ln_fu_134_p3 <= (trunc_ln292_fu_130_p1 & ap_const_lv1_0);
    trunc_ln292_fu_130_p1 <= ap_sig_allocacmp_i(9 - 1 downto 0);
    zext_ln292_1_fu_161_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(or_ln292_fu_156_p2),64));
    zext_ln292_2_fu_170_p0 <= grp_fu_208_p3;
    zext_ln292_2_fu_170_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln292_2_fu_170_p0),64));
    zext_ln292_fu_142_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln_fu_134_p3),64));
end behav;
