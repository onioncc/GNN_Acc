...
entity GAT_compute_one_graph_prepare_out_nodes_features_Pipeline_VITIS_LOOP_172_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of GAT_compute_one_graph_prepare_out_nodes_features_Pipeline_VITIS_LOOP_172_3 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln172_fu_1108_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln172_reg_1459 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln172_reg_1459_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln172_reg_1459_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln172_fu_1114_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    mux_646_28_1_1_U3054 : component GAT_compute_one_graph_mux_646_28_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 28,
    ...
    mux_646_28_1_1_U3055 : component GAT_compute_one_graph_mux_646_28_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 28,
    ...
    mul_28s_28s_46_3_1_U3056 : component GAT_compute_one_graph_mul_28s_28s_46_3_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 28,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln172_fu_1108_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln172_fu_1108_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln172_fu_1114_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_dim_in_1) + unsigned(ap_const_lv7_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln172_fu_1108_p2)
    begin
        if (((icmp_ln172_fu_1108_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln172_fu_1108_p2 <= "1" when (ap_sig_allocacmp_dim_in_1 = num_in_features) else "0";
    ...
    sum_V_2_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln172_reg_1459_pp0_iter2_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln172_reg_1459_pp0_iter2_reg = ap_const_lv1_1))) then 
