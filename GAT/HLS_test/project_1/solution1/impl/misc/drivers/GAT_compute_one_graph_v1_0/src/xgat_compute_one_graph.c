...
void XGat_compute_one_graph_Set_num_heads_per_layer_in(XGat_compute_one_graph *InstancePtr, u64 Data) {
    ...
    XGat_compute_one_graph_WriteReg(InstancePtr->Control_BaseAddress, XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_NUM_HEADS_PER_LAYER_IN_DATA, (u32)(Data));
    XGat_compute_one_graph_WriteReg(InstancePtr->Control_BaseAddress, XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_NUM_HEADS_PER_LAYER_IN_DATA + 4, (u32)(Data >> 32));
}
...
u64 XGat_compute_one_graph_Get_num_heads_per_layer_in(XGat_compute_one_graph *InstancePtr) {
    ...
    Data = XGat_compute_one_graph_ReadReg(InstancePtr->Control_BaseAddress, XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_NUM_HEADS_PER_LAYER_IN_DATA);
    Data += (u64)XGat_compute_one_graph_ReadReg(InstancePtr->Control_BaseAddress, XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_NUM_HEADS_PER_LAYER_IN_DATA + 4) << 32;
    return Data;
}
...
void XGat_compute_one_graph_Set_num_features_per_layer_in(XGat_compute_one_graph *InstancePtr, u64 Data) {
    ...
    XGat_compute_one_graph_WriteReg(InstancePtr->Control_BaseAddress, XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_NUM_FEATURES_PER_LAYER_IN_DATA, (u32)(Data));
    XGat_compute_one_graph_WriteReg(InstancePtr->Control_BaseAddress, XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_NUM_FEATURES_PER_LAYER_IN_DATA + 4, (u32)(Data >> 32));
}
...
u64 XGat_compute_one_graph_Get_num_features_per_layer_in(XGat_compute_one_graph *InstancePtr) {
    ...
    Data = XGat_compute_one_graph_ReadReg(InstancePtr->Control_BaseAddress, XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_NUM_FEATURES_PER_LAYER_IN_DATA);
    Data += (u64)XGat_compute_one_graph_ReadReg(InstancePtr->Control_BaseAddress, XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_NUM_FEATURES_PER_LAYER_IN_DATA + 4) << 32;
    return Data;
}
