...
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_NUM_HEADS_PER_LAYER_IN_DATA           0x34
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_BITS_NUM_HEADS_PER_LAYER_IN_DATA           64
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_NUM_FEATURES_PER_LAYER_IN_DATA        0x40
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_BITS_NUM_FEATURES_PER_LAYER_IN_DATA        64
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_TASK_TB_DATA                          0x4c
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_BITS_TASK_TB_DATA                          64
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_GRAPH_PRED_LINEAR_WEIGHT_FIXED_DATA   0x58
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_BITS_GRAPH_PRED_LINEAR_WEIGHT_FIXED_DATA   64
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_GRAPH_PRED_LINEAR_BIAS_FIXED_DATA     0x64
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_BITS_GRAPH_PRED_LINEAR_BIAS_FIXED_DATA     64
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_GAT_NET_SCORING_FN_TARGET_FIXED_DATA  0x70
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_BITS_GAT_NET_SCORING_FN_TARGET_FIXED_DATA  64
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_GAT_NET_SCORING_FN_SOURCE_FIXED_DATA  0x7c
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_BITS_GAT_NET_SCORING_FN_SOURCE_FIXED_DATA  64
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_GAT_NET_LINEAR_PROJ_WEIGHT_FIXED_DATA 0x88
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_BITS_GAT_NET_LINEAR_PROJ_WEIGHT_FIXED_DATA 64
#define XGAT_COMPUTE_ONE_GRAPH_CONTROL_ADDR_GAT_NET_SKIP_PROJ_WEIGHT_FIXED_DATA   0x94
