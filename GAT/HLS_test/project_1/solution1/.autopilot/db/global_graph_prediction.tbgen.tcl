...
set portList { 
	...
	{ task_r sc_in sc_lv 64 signal 1 } 
	{ pred_linear_bias_V_0 sc_in sc_lv 28 signal 2 } 
	{ h_graph_V_address0 sc_out sc_lv 7 signal 3 } 
	{ h_graph_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ h_graph_V_q0 sc_in sc_lv 28 signal 3 } 
	{ pred_linear_weight_V_address0 sc_out sc_lv 4 signal 4 } 
	{ pred_linear_weight_V_ce0 sc_out sc_logic 1 signal 4 } 
	{ pred_linear_weight_V_q0 sc_in sc_lv 28 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "task_r", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "task_r", "role": "default" }} , 
 	{ "name": "pred_linear_bias_V_0", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "pred_linear_bias_V_0", "role": "default" }} , 
 	{ "name": "h_graph_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "h_graph_V", "role": "address0" }} , 
 	{ "name": "h_graph_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "h_graph_V", "role": "ce0" }} , 
 	{ "name": "h_graph_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "h_graph_V", "role": "q0" }} , 
 	...
 	{ "name": "pred_linear_weight_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "pred_linear_weight_V", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_264_2", "PipelineType" : "pipeline",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_28s_28s_46_3_1_U4228", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	task_r { ap_none {  { task_r in_data 0 64 } } }
	pred_linear_bias_V_0 { ap_none {  { pred_linear_bias_V_0 in_data 0 28 } } }
	h_graph_V { ap_memory {  { h_graph_V_address0 mem_address 1 7 }  { h_graph_V_ce0 mem_ce 1 1 }  { h_graph_V_q0 mem_dout 0 28 } } }
	pred_linear_weight_V { ap_memory {  { pred_linear_weight_V_address0 mem_address 1 4 }  { pred_linear_weight_V_ce0 mem_ce 1 1 }  { pred_linear_weight_V_q0 mem_dout 0 28 } } }
}
