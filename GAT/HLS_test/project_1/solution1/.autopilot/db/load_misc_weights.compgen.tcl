...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 421 \
    name pred_linear_weight_V \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename pred_linear_weight_V \
    op interface \
    ports { pred_linear_weight_V_address0 { O 4 vector } pred_linear_weight_V_ce0 { O 1 bit } pred_linear_weight_V_we0 { O 1 bit } pred_linear_weight_V_d0 { O 28 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'pred_linear_weight_V'"
}
}
...
eval "cg_default_interface_gen_dc { \
    id 418 \
    name graph_pred_linear_weight_fixed \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_graph_pred_linear_weight_fixed \
    op interface \
    ports { graph_pred_linear_weight_fixed { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 419 \
    name graph_pred_linear_bias_fixed \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_graph_pred_linear_bias_fixed \
    op interface \
    ports { graph_pred_linear_bias_fixed { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 420 \
    name pred_linear_bias_V_0 \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_pred_linear_bias_V_0 \
    op interface \
    ports { pred_linear_bias_V_0 { O 28 vector } pred_linear_bias_V_0_ap_vld { O 1 bit } } \
} "
}
