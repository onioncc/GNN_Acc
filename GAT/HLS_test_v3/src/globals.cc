...
FM_VEC scores_target_ping[MAX_NODE];
FM_VEC scores_target_pong[MAX_NODE];
FM_VEC scores_source_ping[EDGE_PARALLEL][ceildiv(MAX_NODE, EDGE_PARALLEL)];
FM_VEC scores_source_pong[EDGE_PARALLEL][ceildiv(MAX_NODE, EDGE_PARALLEL)];
