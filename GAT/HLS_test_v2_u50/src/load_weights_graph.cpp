...
extern std::vector<WT_TYPE, aligned_allocator<WT_TYPE>> graph_pred_linear_weight_fixed[NUM_TASK * FEATURE_OUT];
extern std::vector<WT_TYPE, aligned_allocator<WT_TYPE>> graph_pred_linear_bias_fixed[NUM_TASK];
extern std::vector<WT_TYPE, aligned_allocator<WT_TYPE>> gat_net_scoring_fn_target_fixed[LAYER_NUM * HEAD_NUM * FEATURE_OUT];
extern std::vector<WT_TYPE, aligned_allocator<WT_TYPE>> gat_net_scoring_fn_source_fixed[LAYER_NUM * HEAD_NUM * FEATURE_OUT];
extern std::vector<WT_TYPE, aligned_allocator<WT_TYPE>> gat_net_linear_proj_weight_fixed[LAYER_NUM * HEAD_NUM * FEATURE_OUT * HEAD_NUM * FEATURE_OUT];
extern std::vector<WT_TYPE, aligned_allocator<WT_TYPE>> gat_net_skip_proj_weight_fixed[LAYER_NUM * HEAD_NUM * FEATURE_OUT * HEAD_NUM * FEATURE_OUT];
